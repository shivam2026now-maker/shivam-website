...
import { Aa as useLayer, Ba as gt, Br as Container, Hl as require_compiler_runtime, Ii as useClickOutsideEvent, La as Et, P as useCommentsSelectedPath, Sa as Card, _a as Stack, da as CloseIcon, hi as Layer, li as CheckmarkIcon, lt as useCommentsEnabled, pi as ChevronDownIcon, qs as CommentsOnboardingContext, ut as useAddonDataset, va as Text } from "./DoubleChevronRight-0HZnX8lW.js";
import { Nl as useCurrentUser, lp as fromString, rc as Popover$1, rp as useToast } from "./PerspectiveProvider-CVaQBlks-DnEr8cuE.js";
import { N as useTranslation$1, a as MenuItem$1, b as Box, i as MenuButton$1, l as Menu, t as Button$1, x as Flex } from "./Tab-Dx6d0Ug4-BCC45VDZ.js";
import { _ as isTextSelectionComment, b as useComments, m as commentsLocaleNamespace, x as useCommentsScroll } from "./useComments-CVvkxQg3-DMBFIS2K.js";
import { t as CommentDeleteDialog } from "./CommentsListItem-DwZqY9F--C-WKdrVF.js";
import { n as useCommentsTelemetry, t as CommentsList } from "./useCommentsTelemetry-PyPsqrBr-DF5uRzl_.js";
import { t as UpsellPanel } from "./UpsellPanel-BzCgrrZO-Cb_yXCIz.js";
import { t as useCommentsUpsell } from "./useCommentsUpsell-a8ecO894-j2Cy61OM.js";
//#region node_modules/sanity/lib/CommentsInspector-DCXO30El.js
...
function useCommentsOnboarding() {
	let ctx = (0, import_react.useContext)(CommentsOnboardingContext);
	if (!ctx) throw Error("useCommentsOnboarding: missing context value");
	return ctx;
}
function CommentsInspectorError(t0) {
	let $ = (0, import_compiler_runtime.c)(9), { error } = t0, { t } = useTranslation$1(commentsLocaleNamespace), t1;
	...
	let t3;
	$[4] === error.message ? t3 = $[5] : (t3 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
		size: 1,
		muted: !0,
		children: error.message
	}), $[4] = error.message, $[5] = t3);
	let t4;
	return $[6] !== t2 || $[7] !== t3 ? (t4 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Box, {
		padding: 2,
...
function CommentsInspectorInner(props) {
	...
	let t30;
	$[114] !== handleDeselectPath || $[115] !== t27 || $[116] !== t28 || $[117] !== t29 ? (t30 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
	...
	let t31;
	return $[119] !== t24 || $[120] !== t30 ? (t31 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [t24, t30] }), $[119] = t24, $[120] = t30, $[121] = t31) : t31 = $[121], t31;
}
function _temp(x) {
