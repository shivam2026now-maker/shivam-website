import { n as RequireProps } from "./types-CwJLTYDj.js";
 ...
 * @internal
 */
declare function studioWorkerTask<T = unknown>(filePath: URL, options: StudioWorkerTaskOptions): Promise<T>;
/**
 ...
 * @internal
 */
declare function createStudioWorker(filePath: URL, options: StudioWorkerTaskOptions): Worker;
/**
 ...
 * @internal
 */
declare function tsxWorkerTask<T = unknown>(filePath: URL$1, options: TsxWorkerTaskOptions): Promise<T>;
export { createStudioWorker as n, studioWorkerTask as r, tsxWorkerTask as t };
//# sourceMappingURL=tsxWorkerTask-MHWcAqb6.d.ts.map