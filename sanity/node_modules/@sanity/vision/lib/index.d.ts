...
declare const visionLocaleStrings: {
  ...
  readonly 'label.shared': 'Shared';
  /** Label for saved query type "team" */
  readonly 'label.team': 'Team';
  /** Label for untitled query fallback */
  readonly 'label.untitled-query': 'Untitled';
  ...
  readonly 'query.error.unsupported-release-perspective': 'This API version does not support complex perspectives. Use {{apiVersion}} or later.';
  /** Extra explanation when a 400 is returned for a variant on an incompatible API version */
  readonly 'query.error.unsupported-variant': 'This API version does not support content variants. Use the experimental API version ({{apiVersion}}).';
  ...
  readonly 'save-query.personal-copy-success': 'Personal copy saved';
  /** Warning displayed before sharing a query */
  readonly 'save-query.share-warning': 'Shared queries are stored as documents in your dataset and count toward your document quota.';
  /** Save shared query success label */
  readonly 'save-query.shared-success': 'Shared query saved';
  /** Save success label */
  readonly 'save-query.success': 'Query saved';
  /** Save unshared query success label */
  readonly 'save-query.unshared-success': 'Query moved to personal';
  ...
  readonly 'settings.api-version-locked-for-variant': 'When a variant is selected, the API version needs to be vX.';
