 ...
 * @public
 */
export declare const configDefinition: z.ZodMiniObject<
  {
    formatGeneratedCode: z.ZodMiniDefault<
      z.ZodMiniUnion<
        readonly [
          z.ZodMiniBoolean<boolean>,
          z.ZodMiniEnum<{
            oxfmt: 'oxfmt'
            prettier: 'prettier'
          }>,
      ...
      >
    >
    generates: z.ZodMiniDefault<z.ZodMiniString<string>>
    overloadClientMethods: z.ZodMiniDefault<z.ZodMiniBoolean<boolean>>
    path: z.ZodMiniDefault<
      z.ZodMiniUnion<readonly [z.ZodMiniString<string>, z.ZodMiniArray<z.ZodMiniString<string>>]>
    >
 ...
 * @public
 */
export declare type TypegenProgressEvent =
  | {
      type: 'schemaLoaded'
    }
  | {
