...
function shasum(data) {
    return _async_to_generator(function() {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    subtle = getCrypto().subtle;
                    return [
                        4,
                        subtle.digest('SHA-256', data.buffer)
                    ];
                case 1:
                    digest = _state.sent();
                    return [
...
function hex(data) {
    return _to_consumable_array(data).map(function(i) {
        return i.toString(16).padStart(2, '0');
    }).join('');
}
// Sample file to verify checksum against
var file = '7eeec7b86ddfefd7d7b66e137b2b9220a527528f-185x278.jpg';
test('untar movies dataset export', function() {
    return _async_to_generator(function() {
        var fileStream, _iteratorAbruptCompletion, _didIteratorError, _iteratorError, _iterator, _step, _value, _value1, header, body, chunks, sum, err;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    fileStream = readFileAsWebStream("".concat(import.meta.dirname, "/fixtures/movies.tar"));
                ...
                case 3:
                    ...
                    if (!header.name.includes(file)) return [
                        3,
                        6
                    ];
                    return [
                        4,
                        toArray(streamToAsyncIterator(body))
                    ];
                case 4:
                    chunks = _state.sent();
                    return [
                        4,
                        shasum(concatUint8Arrays(chunks))
                    ];
                case 5:
                    sum = _state.sent();
