...
import { Ba as gt, Br as Container, Hl as require_compiler_runtime, Mr as ChevronRightIcon, Rr as BoundaryElementProvider, _a as Stack, pa as Button, va as Text, za as ft } from "./DoubleChevronRight-0HZnX8lW.js";
import { Il as Translate, am as v4, cp as useTelemetry, jl as LoadingBlock } from "./PerspectiveProvider-CVaQBlks-DnEr8cuE.js";
import { N as useTranslation$1, b as Box, s as Tooltip$1, x as Flex } from "./Tab-Dx6d0Ug4-BCC45VDZ.js";
import { r as defineEvent } from "./dist-DFJA_igs.js";
import { a as CommentInput, d as applyCommentsGroupAttr, g as hasCommentMessageValue, m as commentsLocaleNamespace } from "./useComments-CVvkxQg3-DMBFIS2K.js";
import { n as CommentsListItem, r as ThreadCard } from "./CommentsListItem-DwZqY9F--C-WKdrVF.js";
//#region node_modules/sanity/lib/useCommentsTelemetry-PyPsqrBr.js
...
var separator = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text, {
	muted: !0,
...
function CommentThreadLayout(props) {
	...
	let t8;
	$[30] === children ? t8 = $[31] : (t8 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stack, {
		gap: 2,
		children
	}), $[30] = children, $[31] = t8);
	let t9;
	return $[32] !== t6 || $[33] !== t7 || $[34] !== t8 ? (t9 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Stack, {
		gap: 2,
		children: [
			t6,
			t7,
...
//#endregion
export { useCommentsTelemetry as n, CommentsList as t };
