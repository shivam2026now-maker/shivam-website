import { Qn as defineLocalesResources } from "./PerspectiveProvider-DPuh6brq-CckVPauS.js";
import "./lib-_dkBMC8E.js";
//#region node_modules/sanity/lib/resources-nOFXz6ym.js
/**
...
var structureLocaleStrings = defineLocalesResources("structure", {
	...
	"action.delete.disabled.target-not-found": "The selected release or variant does not contain this document",
	...
	"action.discard-changes.disabled.target-not-found": "The selected release or variant does not contain this document",
	...
	/** Tooltip when action is disabled because the selected release or variant does not contain this document */
	"action.duplicate.disabled.target-not-found": "The selected release or variant does not contain this document",
	...
	/** Tooltip when action is disabled because the selected release or variant does not contain this document */
	"action.publish.disabled.target-not-found": "The selected release or variant does not contain this document",
	...
	"action.publish.validation-issues-toast.description": "Please fix the validation errors before publishing",
	...
	/** Tooltip when action is disabled because the selected release or variant does not contain this document */
	"action.unpublish.disabled.target-not-found": "The selected release or variant does not contain this document",
	...
	"banners.obsolete-draft.actions.compare-draft.tooltip": "The published document doesn't exist, so this draft can't be compared.",
	...
	* */
	...
	"banners.variant.definition-not-found": "The selected variant <VariantName>{{name}}</VariantName> could not be found.",
	/** Toast description in case an error occurs when adding a document to a variant */
	"banners.variant.error.description": "An error occurred when adding document to the variant: {{message}}",
	...
	"banners.variant.not-in-variant": "No <PerspectiveTitle>{{perspectiveTitle}}</PerspectiveTitle> variant document exists for <VariantBadge>{{variantTitle}}</VariantBadge>.",
	...
	"confirm-delete-dialog.confirmation.text_delete_one": "Are you sure you want to delete this document?",
	/** The confirmation text when the document has multiple versions */
	"confirm-delete-dialog.confirmation.text_delete_other": "Are you sure you want to delete all the versions of this document?",
	/** If no referring documents are found, this text appears above the cancel and confirmation buttons */
	...
	"document-target-badges.not-in-target.tooltip": "Document doesn't exist in the selected perspective yet.",
	...
	"document-view.form-view.sync-pending.description": "We'll keep trying. Your changes are kept in your browser in the meantime.",
	...
	"document-view.form-view.sync-recovering.description": "Editing resumes as soon as your changes are saved.",
	...
	"document-view.form-view.sync-stalled.description": "Editing is paused until they save. Your changes are kept in your browser, so keep this tab open while we keep trying.",
	...
	"panes.document-list-pane.sort-order.disabled-reason": "This sorting option uses fields that are not part of this document type",
	...
	"panes.document-operation-results.operation-success_unpublishVersion": "Version will be unpublished when the release is published",
