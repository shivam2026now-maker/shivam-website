import { m as SanityConfig, s as DocumentResource, t as SanityInstance } from "../createSanityInstance-DCePpBYW.js";
import { B as parseQueryKey, R as getQueryKey, Si as defineMutation, _i as FetcherDefinition, bi as MutationResult, et as PreviewQueryResult, gi as Fetcher, gr as getCommentsOptionsKey, hi as CacheWriter, mi as CacheTag, tt as PreviewValue, vi as FetcherSnapshot, vr as parseCommentsOptionsKey, xi as defineFetcher, yi as MutationDefinition, yt as GetUsersOptions } from "../authStore-C-OEkGaM.js";
...
/** @internal */
declare const getUsersKey: (instance: SanityInstance, { resourceType, organizationId, batchSize, projectId, userId }?: GetUsersOptions) => string;
/** @internal */
