import { D as StructureResolver, L as DefaultDocumentNodeResolver, R as StructureBuilder, V as UserViewComponent, _n as ComponentView, gn as FormViewBuilder, hn as FormView, i as PaneRouterContextValue, k as StructureToolContextValue, lt as SerializePath, s as DocumentPaneContextValue, vn as ComponentViewBuilder, y as PaneNode } from "./types-CPL35yMg.js";
...
import { Path, SanityDocument, SanityDocumentLike } from "@sanity/types";
import { CardProps } from "@sanity/ui";
import { PerspectiveStack, ReleaseId, Source, TimelineStore } from "sanity";
/** @internal */
 ...
 * @internal
 */
interface DeleteReferenceCounts {
...
/** @internal */
declare function ConfirmDeleteDialogContainer(props: ConfirmDeleteDialogProps): import("react").JSX.Element;
/**
 *
 * @hidden
 ...
 * @beta This API will change. DO NOT USE IN PRODUCTION.
 */
declare function PaneLayout(props: PaneLayoutProps & CardProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref' | 'wrap'>): import("react").JSX.Element;
/**
 *
 * @hidden
 * @beta
...
declare const structureLocaleStrings: {
  ...
  'action.copy-document-id.label': string;
  ...
  'action.copy-link-to-document.label': string;
  ...
  'action.delete.disabled.target-not-found': string;
  /** Tooltip when action button is disabled because the document exists in scheduled releases */
  'action.delete.disabled.scheduled-release': string;
  ...
  'action.discard-changes.disabled.target-not-found': string;
  ...
  /** Tooltip when action is disabled because the selected release or variant does not contain this document */
  'action.duplicate.disabled.target-not-found': string;
  ...
  'action.publish.disabled.not-publishable': string;
  /** Tooltip when action is disabled because the selected release or variant does not contain this document */
  'action.publish.disabled.target-not-found': string;
  ...
  /** Label for the "Publish" document action while publish is being executed.*/
  'action.publish.validation-in-progress.label': string;
  /** Toast description when trying to publish with validation errors */
  'action.publish.validation-issues-toast.description': string;
  /** Toast title when trying to publish with validation errors */
  'action.publish.validation-issues-toast.title': string;
  ...
  'banners.paused-scheduled-draft.text': string;
  ...
  'banners.release.action.add-to-bundle': string;
  ...
  'compare-version.error.loadReleases.title': string;
  /** The error message shown when document versions or variants failed to load */
  'compare-version.error.loadVersions.title': string;
  ...
  'confirm-delete-dialog.confirm-anyway-button.text_delete_one': string;
  /** The text in the "Delete anyway" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-anyway-button.text_delete_other': string;
  ...
  'confirm-delete-dialog.confirm-button.text_delete_one': string;
  /** The text in the "Delete now" button when the document has multiple versions */
  'confirm-delete-dialog.confirm-button.text_delete_other': string;
  ...
  'confirm-delete-dialog.confirmation.text_delete_one': string;
  /** The confirmation text when the document has multiple versions */
  'confirm-delete-dialog.confirmation.text_delete_other': string;
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  'document-group-inventory.onboarding-hint': string;
  ...
  'document-target-badges.not-in-target.tooltip': string;
  ...
  'menu-items.layout.restore-default': string;
  /** Tooltip shown when the restore-default layout item is disabled (default already in use) */
  'menu-items.layout.restore-default.disabled-reason': string;
  ...
  'menu-items.sort-by.restore-default': string;
  /** Tooltip shown when the restore-default sort item is disabled (default already in use) */
  'menu-items.sort-by.restore-default.disabled-reason': string;
  ...
  'panes.document-operation-results.operation-success_copy-id': string;
  ...
  'panes.document-operation-results.operation-success_publishVersion': string;
  ...
  'panes.document-operation-results.operation-success_unpublishVersion': string;
  ...
  'panes.document-pane.variant-target.loading': string;
...
/** @internal */
declare function DocumentInspectorHeader(props: DocumentInspectorHeaderProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref'>): import("react").JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const PaneContainer: import("react").MemoExoticComponent<(props: BaseStructureToolPaneProps<'documentList'>) => import("react").JSX.Element>;
/**
 * @internal
 */
...
/** @internal */
declare function createStructureBuilder({ defaultDocumentNode, source, perspectiveStack, selectedVariantName }: StructureBuilderOptions): StructureBuilder;
/** @internal */
...
/** @internal */
declare const form: (spec?: Partial<FormView>) => FormViewBuilder;
/** @internal */
declare const component: (componentOrSpec?: UserViewComponent | Partial<ComponentView>) => ComponentViewBuilder;
/** @internal */
...
/** @internal */
declare function StructureToolProvider({ defaultDocumentNode, structure: resolveStructure, children }: StructureToolProviderProps): React.JSX.Element;
/** @internal */
declare function useStructureTool(): StructureToolContextValue;
export { BaseStructureToolPaneProps as C, ConfirmDeleteDialogProps as S, StructureLocaleResourceKeys as _, form as a, PaneLayout as b, StructureBuilderOptions as c, PaneContainer as d, UseDocumentTitle as f, DocumentInspectorHeader as g, DocumentPaneProviderProps as h, component as i, createStructureBuilder as l, useDocumentPane as m, StructureToolProvider as n, HELP_URL as o, useDocumentTitle as p, StructureToolProviderProps as r, SerializeError as s, useStructureTool as t, DocumentListPaneProps as u, PaneRouterContext$1 as v, getTypeNamesFromFilter as w, ConfirmDeleteDialogContainer as x, usePaneRouter as y };
//# sourceMappingURL=useStructureTool-Co_K65Tt.d.ts.map