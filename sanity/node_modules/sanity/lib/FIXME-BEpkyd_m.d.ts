import { $o as BlockStyleProps, Bs as ObjectItemProps, C as FormDocumentValue, D as TrackerContextGetSnapshot, Eo as BooleanInputProps, Ga as LocaleDefinition, Mo as ObjectInputProps, N as ReporterHook, Ot as Workspace, Qc as DocumentFieldAction, Qo as BlockProps, Rc as FormNodePresence, So as ArrayOfObjectsInputProps, Ua as Locale, Vs as PrimitiveItemProps, Xo as BlockDecoratorProps, Yo as BlockAnnotationProps, Zo as BlockListItemProps, bl as FormSetPatch, c as PatchChannel, dl as FormDiffMatchPatch, fl as FormIncPatch, fo as ArrayFieldProps, g as StateTree, hl as FormPatch, ho as BooleanFieldProps, ic as ReleaseId, is as BaseFormNode, ji as EditStateFor, jo as NumberInputProps, kl as PreviewProps, ll as PatchEvent, ml as FormInsertPatchPosition, ms as ObjectRenderMembersCallback, p as FormState, pl as FormInsertPatch, po as ArrayOfPrimitivesFieldProps, ps as ObjectFormNode, sc as TargetPerspective, t as VirtualizerScrollInstance, ts as PortableTextPluginsProps, ul as FormDecPatch, vo as NumberFieldProps, w as ChangeIndicatorTrackerContextValue, wo as ArrayOfPrimitivesInputProps, ws as FieldsetRenderMembersCallback, xl as FormUnsetPatch, xo as StringFieldProps, y as CopyPasteContextType, yl as FormSetIfMissingPatch, yo as ObjectFieldProps, zo as StringInputProps, zs as ObjectItem } from "./useVirtualizerScrollInstance-gXzFwfIY.js";
import { ComponentType, ElementType, HTMLProps, PropsWithChildren, ReactNode, RefAttributes } from "react";
import { Observable } from "rxjs";
import { DocumentDivergencesContextValue, LocaleContextValue } from "sanity/_singletons";
import { CrossDatasetReferenceSchemaType, CrossDatasetReferenceValue, DeprecatedProperty, FileValue, FormNodeValidation, GeopointValue, ImageValue, IndexTuple, KeyedSegment, ObjectSchemaType, Path, PathSegment, Reference, ReferenceSchemaType, ReferenceValue, Role, SanityDocument, Schema, SlugValue, ValidationMarker } from "@sanity/types";
import { AvatarPosition } from "@sanity/ui";
import { FallbackNs } from "react-i18next";
import { FlatNamespace, KeyPrefix, Namespace, TFunction, i18n } from "i18next";
/**
 *
 * @hidden
 * @beta
...
/** @internal */
interface ScrollContainerProps<T extends ElementType> extends Omit<HTMLProps<T>, 'as' | 'onScroll' | 'ref'> {
  as?: ElementType | keyof React.JSX.IntrinsicElements;
  onScroll?: (event: Event) => () => void;
}
declare function ScrollContainerComponent<T extends ElementType = 'div'>(props: ScrollContainerProps<T> & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/**
 ...
 * @internal
 */
declare const ScrollContainer: import("react").MemoExoticComponent<typeof ScrollContainerComponent>;
/** @internal */
 ...
 * @internal
 */
declare const DivergencesProvider: ComponentType<Props>;
/**
 * @internal
 */
 ...
 * @alpha
 */
interface FormBuilderProps extends Omit<ObjectFormNode, 'level' | 'path' | 'presence' | 'validation' | '_allMembers' | '__unstable_computeDiff' | 'displayInlineChanges' | 'changedFromBaseVariant' | 'hasBaseVariant'> {
  /**
 ...
 * @public
 */
declare function useTranslation$1<Ns extends FlatNamespace | $Tuple<FlatNamespace> | undefined = undefined, KPrefix extends KeyPrefix<FallbackNs<Ns>> = undefined>(ns?: Ns, options?: UseTranslationOptions<KPrefix>): UseTranslationResponse<FallbackNs<Ns>, KPrefix>;
/**
 ...
 * @public
 */
type TranslateComponentMap<TComponentProps extends object = object> = Record<string, ComponentType<{
  children?: ReactNode;
} & TComponentProps> | keyof React.JSX.IntrinsicElements>;
/**
 * Props for the `Translate` component.
 *
 * @public
 */
interface TranslationProps<TComponentProps extends object = object> {
  /**
 ...
 * @public
 */
declare function Translate<TComponentProps extends object = object>(props: TranslationProps<TComponentProps>): import("react").JSX.Element;
/**
 * @internal
 */
...
/** @internal */
type FIXME = any;
export { prefixPath as $, useCurrentLocale as A, StudioCrossDatasetReferenceInput as At, FormBuilder as B, TranslateComponentMap as C, ScrollContainer as Ct, UseTranslationOptions as D, useChangeIndicatorsReporter as Dt, usEnglishLocale as E, useChangeIndicatorsReportedValues as Et, RelativeTimeOptions as F, SetActiveGroupOperation as G, ExpandFieldSetOperation as H, useRelativeTime as I, SANITY_PATCH_TYPE as J, getExpandOperations as K, UseDateTimeFormatOptions as L, LocaleProvider as M, LocaleProviderBase as N, UseTranslationResponse as O, StudioReferenceInput as Ot, useSchema as P, insert as Q, useDateTimeFormat as R, Translate as S, stringToPath as St, defaultLocale as T, ChangeIndicatorsTracker as Tt, ExpandOperation as U, FormBuilderProps as V, ExpandPathOperation as W, diffMatchPatch as X, dec as Y, inc as Z, FieldPresenceInner as _, normalizeIndexTupleSegment as _t, WorkspaceProviderProps as a, useDocumentDivergences as at, FieldPresenceWithOverlay as b, pathToString as bt, useCopyPaste as c, FormInputRelativePathArg as ct, ProjectGrants as d, findIndex as dt, set as et, ProjectOrganizationData as f, getItemKey as ft, FieldPresence as g, normalizeIndexSegment as gt, PresenceOverlayProps as h, isEmptyObject as ht, WorkspaceProvider as i, DivergencesProvider as it, useLocale as j, StudioCrossDatasetReferenceInputProps as jt, useTranslation$1 as k, StudioReferenceInputProps as kt, ProjectData as l, FormFieldHeaderText as lt, PresenceOverlay as m, getValueAtPath as mt, EMPTY_ARRAY as n, unset as nt, useWorkspace as o, FormInput as ot, ProjectStore as p, getItemKeySegment as pt, setAtPath as q, EMPTY_OBJECT as r, VirtualizerScrollInstanceProvider as rt, CopyPasteProvider as s, FormInputAbsolutePathArg as st, FIXME as t, setIfMissing as tt, ProjectDatasetData as u, FormFieldHeaderTextProps as ut, FieldPresenceInnerProps as v, normalizeKeySegment as vt, TranslationProps as w, ScrollContainerProps as wt, PerspectiveProvider as x, pathsAreEqual as xt, FieldPresenceProps as y, normalizePathSegment as yt, TransformPatches as z };
//# sourceMappingURL=FIXME-BEpkyd_m.d.ts.map