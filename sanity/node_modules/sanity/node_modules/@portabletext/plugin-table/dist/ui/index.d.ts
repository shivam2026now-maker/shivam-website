import { t as TableContainers } from "../define-table-dT1Rll2-.js";
import { ContainerRenderProps } from "@portabletext/editor";
 ...
 * @public
 */
declare const referenceContainers: TableContainers;
/**
 ...
 * @public
 */
type TableMenuProps = TableMenuHandlers & {
 ...
 * @public
 */
declare function Table({ attributes, children, node, path, portalElement, renderMenu, icons, labels, tokens }: ContainerRenderProps & {
  /**
 ...
 * @public
 */
declare function TableRow({ attributes, children, selected }: ContainerRenderProps): JSX.Element;
/**
 ...
 * @public
 */
declare function TableCell({ attributes, children, node, path }: ContainerRenderProps): JSX.Element;
export { Table, TableCell, type TableLabels, type TableMenuProps, TableRow, type TableTokens, referenceContainers };
