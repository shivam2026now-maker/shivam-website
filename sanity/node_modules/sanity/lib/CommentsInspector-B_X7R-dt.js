...
import { b as commentsLocaleNamespace, f as isTextSelectionComment, t as useComments, y as useCommentsScroll } from "./useComments-Dr_DN46L.js";
...
import { Card, Layer, useClickOutsideEvent, useLayer } from "@sanity/ui";
import { keyframes, styled } from "styled-components";
import { Box as Box$1, Container as Container$1, Flex as Flex$1, Text as Text$1, VStack } from "ui5";
...
function CommentsOnboardingPopover(props) {
	...
	let t1;
	$[5] === t0 ? t1 = $[6] : (t1 = /* @__PURE__ */ jsx(Text$1, {
		weight: "medium",
		size: 1,
		as: "div",
		trim: !0,
	...
	let t3;
	$[9] === t2 ? t3 = $[10] : (t3 = /* @__PURE__ */ jsx(Text$1, {
		size: 1,
		as: "div",
		trim: !0,
		children: t2
...
function CommentsUpsellPanel(props) {
	...
	return $[0] !== data || $[1] !== onPrimaryClick || $[2] !== onSecondaryClick ? (t0 = /* @__PURE__ */ jsx(Container$1, {
		size: 1,
...
function CommentsInspectorError(t0) {
	...
	let t2;
	$[2] === t1 ? t2 = $[3] : (t2 = /* @__PURE__ */ jsx(Text$1, {
		size: 1,
		weight: "medium",
		as: "div",
		trim: !0,
	...
	let t3;
	$[4] === error.message ? t3 = $[5] : (t3 = /* @__PURE__ */ jsx(Text$1, {
		size: 1,
		muted: !0,
		as: "div",
		trim: !0,
...
//# sourceMappingURL=CommentsInspector-B_X7R-dt.js.map