/// <reference path="vendor/mux-embed.d.ts" preserve="true" />
import { Options, Mux } from 'mux-embed';
...
export declare const MaxAutoResolution: {
    readonly upTo720p: "720p";
    readonly upTo1080p: "1080p";
    readonly upTo1440p: "1440p";
    readonly upTo2160p: "2160p";
...
export type MuxMediaState = WeakMap<HTMLMediaElement, Partial<MuxMediaProps> & {
    seekable?: TimeRanges;
...
export type MuxMediaEventsMap = {
    ...
    targetlivewindowchange: CustomEvent<{
        composed: true;
        bubbles: true;
    }>;
    streamtypechange: CustomEvent<{
        composed: true;
        bubbles: true;
    }>;
    seekablechange: CustomEvent<{
        composed: true;
    }>;
    error: CustomEvent<{
        detail: MediaError;
