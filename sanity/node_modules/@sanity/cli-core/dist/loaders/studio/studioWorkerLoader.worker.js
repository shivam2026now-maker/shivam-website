...
const defaultViteConfig = {
    ...
    define: {
        ...
        ...applicationId ? {
            __SANITY_APP_ID__: JSON.stringify(applicationId)
        } : {},
        ...Object.fromEntries(Object.entries(studioEnvVars).map(([key, value])=>[
                `process.env.${key}`,
...
const lifecycle = process.env.STUDIO_WORKER_ONE_SHOT === '1' && parentPort ? createOneShotWorkerLifecycle({
    closeServer: async ()=>{
