import "./useVirtualizerScrollInstance-gXzFwfIY.js";
import "./index-BCCyfvTv.js";
import { Observable } from "rxjs";
import { AssetSource, FieldDefinitionBase, InitialValueProperty, ObjectDefinition, ObjectOptions, ObjectSchemaType, Reference, RuleDef, UploadState, ValidationBuilder } from "@sanity/types";
...
declare function defineVideoField(definition: Omit<VideoDefinition$1, 'type'> & FieldDefinitionBase): {
  ...
  preview?: import("@sanity/types").PreviewConfig<Record<string, string>, Record<string, any>> | undefined;
} & FieldDefinitionBase & import("@sanity/types").WidenValidation & import("@sanity/types").WidenInitialValue;
