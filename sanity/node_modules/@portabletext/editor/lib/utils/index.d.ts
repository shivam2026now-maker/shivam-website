import { I as BlockOffset, at as EditorSelectionPoint, cn as KeyedSegment, et as EditorContext, it as EditorSelection, ln as Path, on as BlockPath, un as PathSegment, xt as TraversalSnapshot } from "../behavior.types.action-C0XDEQnB.js";
import { PortableTextBlock, PortableTextTextBlock, isSpan, isTextBlock } from "@portabletext/schema";
/**
 * @public
 */
declare function blockOffsetToSpanSelectionPoint({ snapshot, blockOffset, direction }: {
 ...
 * @public
 */
declare function spanSelectionPointToBlockOffset({ snapshot, selectionPoint }: {
  snapshot: TraversalSnapshot;
 ...
 * @public
 */
declare function blockOffsetsToSelection({ snapshot, offsets, backward }: {
  snapshot: TraversalSnapshot;
  offsets: {
    anchor: BlockOffset;
    focus: BlockOffset;
 ...
 * @public
 */
declare function childSelectionPointToBlockOffset({ snapshot, selectionPoint }: {
  snapshot: TraversalSnapshot;
  selectionPoint: EditorSelectionPoint;
}): BlockOffset | undefined;
/**
 * @public
 */
declare function getBlockEndPoint({ context, block }: {
 ...
 * @public
 */
declare function getBlockStartPoint({ context, block }: {
  context: Pick<EditorContext, 'schema'>;
  block: {
    node: PortableTextBlock;
    path: BlockPath;
 ...
 * @beta
 */
declare function mergeTextBlocks({ context, targetBlock, incomingBlock }: {
 ...
 * @public
 */
declare function sliceBlocks({ context, blocks }: {
