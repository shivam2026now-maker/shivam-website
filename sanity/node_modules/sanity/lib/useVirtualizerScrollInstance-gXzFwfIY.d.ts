import { CSSProperties, ClipboardEventHandler, ComponentProps, ComponentType, ErrorInfo, FocusEvent, FocusEventHandler, FormEventHandler, ReactNode, RefObject } from "react";
import { Observable, Subject } from "rxjs";
import { ArraySchemaType, AssetMetadataType, AssetSource, AssetSourceSpec, BlockDecoratorDefinition, BlockListDefinition, BlockStyleDefinition, BooleanSchemaType, ConditionalProperty, CrossDatasetReferenceValue, CrossDatasetType, CurrentUser, DocumentSystem, FileValue, FormNodeValidation, GeopointValue, GlobalDocumentReferenceType, I18nTextRecord, ImageUrlFitMode, ImageValue, InitialValueProperty, IntrinsicTypeName, KeyedObject, KeyedSegment, MendozaEffectPair, NumberSchemaType, ObjectField, ObjectFieldType, ObjectSchemaType, PatchOperations, Path, PathSegment, PortableTextBlock, PortableTextObject, PortableTextTextBlock, PrepareViewOptions, PreviewValue, Reference, ReferenceValue, SanityDocument, SanityDocumentLike, Schema, SchemaType, SchemaTypeDefinition, SearchStrategy, SlugValue, StringSchemaType, TransactionLogEventWithEffects, TransactionLogEventWithMutations, User, ValidationMarker } from "@sanity/types";
import { ButtonTone, DialogProps } from "@sanity/ui";
import { CSSProperties as CSSProperties$1 } from "styled-components";
import { ClientConfig, ClientPerspective, QueryParams, ReconnectEvent, ReleaseDocument, ResetEvent, SanityClient, SingleMutationResult, StackablePerspective, WelcomeBackEvent, WelcomeEvent } from "@sanity/client";
import { DRAFTS_FOLDER, DraftId, PublishedId, VERSION_FOLDER, getDraftId, getPublishedId as getPublishedId$1, getVersionFromId as getVersionFromId$1, getVersionId, isDraftId, isPublishedId as isPublishedId$1, isVersionId } from "@sanity/client/csm";
import { Mutation } from "@sanity/mutator";
import { ValidateDocumentWorkspaceOptions } from "@sanity/validation";
...
import { EditorSelection, HotkeyOptions, InvalidValueResolution, OnCopyFn, OnPasteResultOrPromise, PasteData, Patch, PortableTextEditor, RangeDecoration } from "@portabletext/editor";
...
import { TFunction as TFunction$1, i18n } from "i18next";
/**
 ...
 * @hidden
 * @beta */
interface DocumentFieldActionsResolverContext extends ConfigContext {
  documentId: string;
  documentType: string;
  schemaType: SchemaType;
}
 ...
 */
declare const VARIANTS_STUDIO_CLIENT_OPTIONS: SourceClientOptions;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function isVariantId(maybeVariantId: unknown): maybeVariantId is VariantId;
/**
 * @beta
 */
...
declare const studioLocaleStrings: {
  ...
  'changes.from-base-variant.label': string;
  ...
  'document-group-inventory.action.cancel': string;
  /** The label for the button that opens the document group inventory */
  'document-group-inventory.action.manage-versions': string;
  ...
  'document-status.published-at': string;
  ...
  'form.field.actions-menu.title': string;
  ...
  'release.action.edit-details': string;
  ...
  'release.toast.edit-release-error.title': string;
  ...
  'user-menu.action.claim-project': string;
...
interface OperationsAPI {
  ...
  publish: Operation<[options?: PublishOptions], 'LIVE_EDIT_ENABLED' | 'ALREADY_PUBLISHED' | 'NO_CHANGES' | 'NOT_PUBLISHABLE' | 'TARGET_NOT_FOUND'> | GuardedOperation;
  ...
  unpublish: Operation<[], 'LIVE_EDIT_ENABLED' | 'NOT_PUBLISHED' | 'ALREADY_UNPUBLISHED' | 'TARGET_NOT_FOUND'> | GuardedOperation;
...
/** @internal */
type ObserveDocumentTypeFromIdFn = (id: string, apiConfig?: ApiConfig, perspective?: StackablePerspective[], variant?: string) => Observable<string | undefined>;
/**
 * @hidden
 * @beta */
interface ObservePathsFn {
  (value: Previewable, paths: (string | PreviewPath)[], apiConfig?: ApiConfig, perspective?: StackablePerspective[], variant?: string): Observable<PreviewValue | SanityDocumentLike | Reference | string | null>;
}
/**
 * @hidden
 * @beta */
...
interface DocumentPreviewStore {
  ...
  observeDocumentTypeFromId: (id: string, apiConfig?: ApiConfig, perspective?: StackablePerspective[], variant?: string) => Observable<string | undefined>;
  observeDocumentSystemFromId: (id: string, apiConfig?: ApiConfig, perspective?: StackablePerspective[], variant?: string) => Observable<DocumentSystem | undefined>;
  /**
   *
   * @hidden
   * @beta
...
/** @beta */
type ValidateDocumentOptions = ValidateDocumentWorkspaceOptions;
/**
 * Validates a document against the schema in the given workspace.
 *
 * @beta
 */
declare function validateDocument(options: ValidateDocumentOptions): Promise<import("@sanity/validation").DocumentValidationMarker[]>;
...
/**
 * A single document in a release, along with its validation status.
 * Returned by {@link useReleaseDocuments}.
 *
 * @public
 */
type DocumentInRelease = BundleDocument;
/**
 * @public
 */
 ...
 * @public
 */
type ReleaseActionsContext = ConfigContext & ReleaseActionProps;
/**
 * @hidden
 * @beta */
 ...
 * @beta
 */
type AssetSourceResolver = ComposableOption<AssetSource[], ConfigContext>;
/**
 * @public
 */
...
/** @internal */
interface FormBuilderComponentResolverContext extends ConfigContext {
  schemaType: SchemaType;
}
/**
...
/** @public */
type TemplateResolver = ComposableOption<Template[], ConfigContext>;
/**
 * @hidden
 * @beta
 */
interface SchemaPluginOptions {
  name?: string;
  types?: SchemaTypeDefinition[] | ComposableOption<SchemaTypeDefinition[], Omit<ConfigContext, 'schema' | 'currentUser' | 'getClient' | 'client' | 'i18n'>>;
 ...
 * @beta
 */
interface NewDocumentOptionsContext extends ConfigContext {
 ...
 * @beta
 */
interface DocumentLanguageFilterContext extends ConfigContext {
  documentId?: string;
  schemaType: string;
}
/**
 ...
 * @beta
 */
interface ResolveProductionUrlContext extends ConfigContext {
 ...
 * @beta
 */
interface DocumentActionsContext extends ConfigContext {
  documentId?: string;
  schemaType: string;
 ...
 * @beta
 */
interface DocumentBadgesContext extends ConfigContext {
  documentId?: string;
  schemaType: string;
}
/** @hidden @beta */
interface DocumentInspectorContext extends ConfigContext {
  documentId?: string;
  documentType: string;
}
/** @hidden @beta */
 ...
 * @beta
 */
type PartialContext<TContext extends ConfigContext> = Pick<TContext, Exclude<keyof TContext, keyof ConfigContext>>;
/** @internal*/
...
export { DocumentInspectorContext as $, LocalesBundlesOption as $a, DocumentFieldActionDivider as $c, StoreRequestErrorHandler as $i, DocumentRevision as $n, BlockStyleProps as $o, TypeChangeDiff$1 as $r, UploaderResolver as $s, ObserveForPreviewFn as $t, useTrackerStoreReporter as A, ValuelessSearchOperatorParams as Aa, isSystemBundle as Ac, getDocumentVariantType as Ai, GetHookCollectionStateProps as An, InputProps as Ao, BooleanDiff$1 as Ar, FieldError as As, WorkspaceHiddenProperty as At, BetaFeatures as B, CookielessCompatibleLoginMethod as Ba, Position as Bc, getPairListener as Bi, DocumentActionPopoverDialogProps as Bn, RenderAnnotationCallback as Bo, FieldChangeNode as Br, ObjectItemProps as Bs, ToolMenuProps as Bt, FormDocumentValue as C, SearchOperatorBase as Ca, getPublishedId$1 as Cc, isEditDocumentVersionEvent as Ci, GeneralDocumentListLayoutKey as Cl, DocumentInspectorMenuItem as Cn, ArrayOfPrimitivesElementType as Co, createBufferedDocument as Cr, FieldSetMember as Cs, Source as Ct, TrackerContextGetSnapshot as D, SearchOperatorParams as Da, isDraft as Dc, isUnscheduleDocumentVersionEvent as Di, PreviewLayoutKey as Dl, DocumentBadgeComponent as Dn, ComplexElementProps as Do, AnnotationDetails as Dr, FieldsetState as Ds, Tool as Dt, TrackedChange as E, SearchOperatorInput as Ea, idMatchesPerspective as Ec, isUnpublishDocumentEvent as Ei, PreviewComponent as El, defineDocumentInspector as En, BooleanInputProps as Eo, Annotation as Er, FieldsetMembers as Es, TemplateResolver as Et, AppsOptions as F, AuthStore as Fa, systemBundles as Fc, DocumentStoreExtraOptions as Fi, DocumentActionDescription as Fn, PasteData$1 as Fo, Diff$1 as Fr, TypeAnnotationMismatchError as Fs, LogoProps as Ft, DefaultPluginsWorkspaceOptions as G, LocaleDefinition as Ga, Size as Gc, CommitFunction as Gi, isSanityDefinedAction as Gn, RenderInputCallback as Go, NullDiff$1 as Gr, UploadEvent as Gs, ValidateDocumentOptions as Gt, Config as H, ImplicitLocaleResourceBundle as Ha, Rect as Hc, IdPair as Hi, DuplicateActionProps as Hn, RenderArrayOfPrimitivesItemCallback as Ho, FromToIndex as Hr, ArrayInputCopyEvent as Hs, ReleaseActionDescription as Ht, AssetSourceResolver as I, HandleCallbackResult as Ia, FormFieldGroup as Ic, InitialSnapshotEvent as Ii, DocumentActionDialogProps as In, PortableTextInputProps as Io, DiffComponent as Ir, UndeclaredMembersError as Is, NavbarAction as It, DocumentActionsVersionType as J, LocaleResourceBundle as Ja, PresenceLocation as Jc, DocumentRebaseEvent as Ji, OperationArgs as Jn, RenderPreviewCallbackProps as Jo, ReferenceDiff as Jr, ResolvedUploader as Js, SourceProvider as Jt, DocumentActionsContext as K, LocaleNestedResource as Ka, DocumentPresence as Kc, CommittedEvent as Ki, MapDocument as Kn, RenderItemCallback as Ko, NumberDiff$1 as Kr, AssetSourcesResolver as Ks, validateDocument as Kt, AsyncComposableOption as L, LoginComponentProps as La, FieldPresenceData as Lc, LatencyReportEvent as Li, DocumentActionGroup as Ln, PrimitiveInputElementProps as Lo, DiffComponentOptions as Lr, BaseItemProps as Ls, NavbarProps as Lt, Reported as M, SearchFieldDefinitionDictionary as Ma, isVersionId as Mc, editState as Mi, DocumentActionComponent as Mn, ObjectInputProps as Mo, ChangeTitlePath as Mr, InvalidItemTypeError as Ms, WorkspaceSummary as Mt, ReporterHook as N, AuthProbeResult as Na, newDraftFrom as Nc, DocumentPairLoadedEvent as Ni, DocumentActionConfirmDialogProps as Nn, OnPasteFn as No, Chunk as Nr, MissingKeysError as Ns, ActiveToolLayoutProps as Nt, TrackerContextStore as O, SearchValueFormatterContext as Oa, isDraftId as Oc, isUpdateLiveDocumentEvent as Oi, PreviewMediaDimensions as Ol, DocumentBadgeDescription as On, EditorChange as Oo, ArrayDiff$1 as Or, ArrayItemError as Os, Workspace as Ot, ActionComponent as P, AuthState as Pa, removeDupes as Pc, DocumentRebaseTelemetryEvent as Pi, DocumentActionCustomDialogComponentProps as Pn, OnPathFocusPayload as Po, ChunkType as Pr, MixedArrayError as Ps, LayoutProps as Pt, DocumentCommentsEnabledContext as Q, LocaleWeekInfo as Qa, DocumentFieldAction as Qc, SnapshotEvent as Qi, snapshotPair as Qn, BlockProps as Qo, StringSegmentUnchanged$1 as Qr, UploaderDef as Qs, DocumentPreviewStoreOptions as Qt, AsyncConfigPropertyReducer as R, AuthConfig as Ra, FormNodePresence as Rc, ListenerEvent as Ri, DocumentActionKeys as Rn, PrimitiveInputProps as Ro, DiffComponentResolver as Rr, ItemProps as Rs, StudioComponents as Rt, SanityClipboardItem as S, OperatorInputComponentProps as Sa, getIdPair as Sc, isDeleteDocumentVersionEvent as Si, PatchArg as Sl, DocumentInspectorComponent as Sn, ArrayOfObjectsInputProps as So, BufferedDocumentWrapper as Sr, FieldMember as Ss, SingleWorkspace as St, TrackedArea as T, SearchOperatorButtonValue as Ta, getVersionId as Tc, isScheduleDocumentVersionEvent as Ti, PortableTextPreviewLayoutKey as Tl, DocumentInspectorUseMenuItemProps as Tn, BaseInputProps as To, createObservableBufferedDocument as Tr, ObjectMember as Ts, SourceOptions as Tt, ConfigContext as U, Locale as Ua, RegionWithIntersectionDetails as Uc, MutationEvent as Ui, DuplicateDocumentActionComponent as Un, RenderBlockCallback as Uo, GroupChangeNode as Ur, ArrayInputInsertEvent as Us, ReleaseActionProps as Ut, ComposableOption as V, LoginMethod as Va, PresentUser as Vc, DocumentPairTarget as Vi, DocumentActionProps as Vn, RenderArrayOfObjectsItemCallback as Vo, FieldOperationsAPI as Vr, PrimitiveItemProps as Vs, ReleaseActionComponent as Vt, ConfigPropertyReducer as W, LocaleConfigContext as Wa, ReportedRegionWithRect as Wc, PendingMutationsEvent as Wi, SanityDefinedAction as Wn, RenderFieldCallback as Wo, ItemDiff$1 as Wr, ArrayInputMoveItemEvent as Ws, ReleaseActionsContext as Wt, DocumentBadgesContext as X, LocaleResourceRecord as Xa, Status as Xc, MutationPayload as Xi, OperationsAPI as Xn, BlockDecoratorProps as Xo, StringDiffSegment as Xr, UploadProgressEvent as Xs, useSource as Xt, DocumentAskToEditEnabledContext as Y, LocaleResourceKey as Ya, Session as Yc, DocumentRemoteMutationEvent as Yi, OperationImpl as Yn, BlockAnnotationProps as Yo, StringDiff$1 as Yr, UploadOptions as Ys, SourceProviderProps as Yt, DocumentBadgesResolver as Z, LocaleSource as Za, UserSessionPair as Zc, RemoteSnapshotEvent as Zi, DocumentVersionSnapshots as Zn, BlockListItemProps as Zo, StringSegmentChanged$1 as Zr, Uploader as Zs, DocumentPreviewStore as Zt, BaseOptions as _, SearchOperatorType as _a, collate as _c, UnscheduleDocumentVersionEvent as _i, FormPatchJSONValue as _l, PreviewableType as _n, FieldProps as _o, Pair as _r, ArrayOfObjectsItemMember as _s, ReleaseActionsResolver as _t, ResourceCacheProviderProps as a, Template as aa, ReleasesNavMenuItemPropsGetter as ac, CreateLiveDocumentEvent as ai, DocumentFieldActionStatus as al, DocumentStackAvailability as an, FormBuilderFilterFieldFn as ao, TimelineController as ar, BooleanFormNode as as, DocumentPluginOptions as at, DocumentMeta as b, I18nSearchOperatorNameKey as ba, documentIdEquals as bc, isCreateLiveDocumentEvent as bi, FormSetPatch as bl, FormComponents as bn, PrimitiveFieldProps as bo, checkoutPair as br, ArrayOfPrimitivesMember as bs, ScheduledPublishingPluginOptions as bt, PatchChannel as c, TemplateItem as ca, SystemVariant as cc, DocumentGroupEvent as ci, DocumentFieldActionsResolverContext as cl, FieldName as cn, PortableTextMarker as co, Timeline as cr, HiddenField as cs, MediaLibraryConfig as ct, RebasePatchMsg as d, TypeTarget as da, CollatedHit as dc, EventsStore as di, FormDiffMatchPatch as dl, ObserveDocumentAvailabilityFn as dn, RenderCustomMarkers as do, DocumentRemoteMutationVersionEvent as dr, NumberFormNode as ds, NewDocumentOptionsContext as dt, defaultTheme as ea, ProvenanceDiffAnnotation as ec, FieldValueError as ei, DocumentFieldActionGroup as el, createDocumentPreviewStore as en, LocalesOption as eo, HistoryStore as er, MarkdownConfig as es, DocumentInspectorsResolver as et, createPatchChannel as f, SearchOperatorDefinitionDictionary as fa, DRAFTS_FOLDER as fc, EventsStoreRevision as fi, FormIncPatch as fl, ObserveDocumentTypeFromIdFn as fn, ArrayFieldProps as fo, Transaction as fr, ObjectArrayFormNode as fs, NewDocumentOptionsResolver as ft, StateTree as g, defineSearchFilterOperators as ga, VERSION_FOLDER as gc, UnpublishDocumentEvent as gi, FormPatchBase as gl, Previewable as gn, FieldCommentsProps as go, MutationResult as gr, StringFormNode as gs, PreparedConfig as gt, useFormState as h, defineSearchFilter as ha, SystemBundle as hc, ScheduleDocumentVersionEvent as hi, FormPatch as hl, PreviewPath as hn, BooleanFieldProps as ho, DocumentVersionEvent as hr, PrimitiveFormNode as hs, PluginOptions as ht, ResourceCacheProvider as i, InitialValueTemplateItem as ia, ReleaseId as ic, CreateDocumentVersionEvent as ii, DocumentFieldActionProps as il, DocumentAvailability as in, FormBuilderCustomMarkersComponent as io, SelectionState as ir, BaseFormNode as is, DocumentLayoutProps as it, IsEqualFunction as j, defineSearchOperator as ja, isSystemBundleName as jc, EditStateFor as ji, HookCollectionActionHook as jn, NumberInputProps as jo, ChangeNode as jr, IncompatibleTypeError as js, WorkspaceOptions as jt, useTrackerStore as k, ValuelessSearchOperatorBuilder as ka, isPublishedId$1 as kc, DocumentVariantType as ki, PreviewProps as kl, DocumentBadgeProps as kn, InputOnSelectFileFunctionProps as ko, ArrayItemMetadata as kr, DuplicateKeysError as ks, WorkspaceHiddenContext as kt, PatchMsg as l, TemplateParameter as la, isVariantId as lc, DocumentVersionEventType as li, PatchEvent as ll, Id as ln, RenderBlockActionsCallback as lo, TimelineOptions as lr, NodeChronologyProps as ls, MissingConfigFile as lt, UseFormStateOptions as m, SearchFilterDefinitionDictionary as ma, PublishedId as mc, PublishDocumentVersionEvent as mi, FormInsertPatchPosition as ml, PreparedSnapshot as mn, BaseFieldProps as mo, DocumentVersion as mr, ObjectRenderMembersCallback as ms, Plugin as mt, useVirtualizerScrollInstance as n, StudioTheme as na, PerspectiveContextValue as nc, StudioLocaleResourceKeys as ni, DocumentFieldActionItem as nl, AvailabilityReason as nn, TFunction$1 as no, createHistoryStore as nr, ArrayOfObjectsFormNode as ns, DocumentLanguageFilterContext as nt, useResourceCache as o, TemplateArrayFieldDefinition as oa, SelectedPerspective as oc, DeleteDocumentGroupEvent as oi, DocumentFieldActionTone as ol, DraftsModelDocument as on, FormBuilderInputComponentMap as oo, TimelineControllerOptions as or, ComputeDiff as os, FormBuilderComponentResolverContext as ot, FormState as p, SearchFilterDefinition as pa, DraftId as pc, HistoryClearedEvent as pi, FormInsertPatch as pl, ObservePathsFn as pn, ArrayOfPrimitivesFieldProps as po, CommitError as pr, ObjectFormNode as ps, PartialContext as pt, DocumentActionsResolver as q, LocalePluginOptions as qa, GlobalPresence as qc, DocumentMutationEvent as qi, Operation as qn, RenderPreviewCallback as qo, ObjectDiff$1 as qr, FileLike as qs, ValidationStatus as qt, ResourceCache as r, StudioThemeColorSchemeKey as ra, PerspectiveStack as rc, BaseEvent as ri, DocumentFieldActionNode as rl, AvailabilityResponse as rn, ArrayInputFunctionsProps as ro, removeMissingReferences as rr, ArrayOfPrimitivesFormNode as rs, DocumentLanguageFilterResolver as rt, MutationPatchMsg as s, TemplateFieldDefinition as sa, TargetPerspective as sc, DeleteDocumentVersionEvent as si, DocumentFieldActionsResolver as sl, DraftsModelDocumentAvailability as sn, FormBuilderMarkersComponent as so, ParsedTimeRef as sr, DocumentFormNode as ss, GroupableActionDescription as st, VirtualizerScrollInstance as t, StudioColorScheme as ta, PerspectiveBundle as tc, getValueError as ti, DocumentFieldActionHook as tl, ApiConfig as tn, StaticLocaleResourceBundle as to, HistoryStoreOptions as tr, PortableTextPluginsProps as ts, DocumentLanguageFilterComponent as tt, PatchMsgSubscriber as u, TemplateReferenceTarget as ua, VARIANTS_STUDIO_CLIENT_OPTIONS as uc, EditDocumentVersionEvent as ui, FormDecPatch as ul, InvalidationChannelEvent as un, RenderBlockActionsProps as uo, CombinedDocument as ur, NodeDiffProps as us, NewDocumentCreationContext as ut, CopyOptions as v, operatorDefinitions as va, createDraftFrom as vc, UpdateLiveDocumentEvent as vi, FormPatchOrigin as vl, Selection as vn, NumberFieldProps as vo, RemoteSnapshotVersionEvent as vr, ArrayOfObjectsMember as vs, ResolveProductionUrlContext as vt, ChangeIndicatorTrackerContextValue as w, SearchOperatorBuilder as wa, getVersionFromId$1 as wc, isPublishDocumentVersionEvent as wi, GeneralPreviewLayoutKey as wl, DocumentInspectorProps as wn, ArrayOfPrimitivesInputProps as wo, CommitRequest as wr, FieldsetRenderMembersCallback as ws, SourceClientOptions as wt, PasteOptions as x, OperatorButtonValueComponentProps as xa, getDraftId as xc, isDeleteDocumentGroupEvent as xi, FormUnsetPatch as xl, DocumentInspector as xn, StringFieldProps as xo, BufferedDocumentEvent as xr, DecorationMember as xs, SchemaPluginOptions as xt, CopyPasteContextType as y, I18nSearchOperatorDescriptionKey as ya, createPublishedFrom as yc, isCreateDocumentVersionEvent as yi, FormSetIfMissingPatch as yl, ObserveDocumentAPIConfig as yn, ObjectFieldProps as yo, WithVersion as yr, ArrayOfPrimitivesItemMember as ys, SanityFormConfig as yt, BaseActionDescription as z, AuthProvider as za, Location as zc, MutationPerformanceEvent as zi, DocumentActionModalDialogProps as zn, StringInputProps as zo, DiffProps as zr, ObjectItem as zs, StudioComponentsPluginOptions as zt };
//# sourceMappingURL=useVirtualizerScrollInstance-gXzFwfIY.d.ts.map