import { b as AuthConfig, c as DocumentTypeHandle, d as ProjectHandle, f as ReleaseHandle, i as DatasetHandle, o as DocumentHandle, s as DocumentResource, t as SanityInstance, u as PerspectiveHandle, x as AuthProvider } from "./createSanityInstance-DUI1bGIg.js";
...
import { CurrentUser, CurrentUser as CurrentUser$1, Mutation, PatchOperations, Path, PortableTextBlock, Role, SanityDocument as SanityDocument$1, SanityDocument as SanityDocument$3, SanityDocumentLike } from "@sanity/types";
...
type ApplicationConfigShape<Include extends ApplicationInclude> = Included<ApplicationInclude, 'config.studio', Include, {
  config: {
 ...
 * @public
 */
type InstallationInclude = 'activeConfig' | 'access' | 'interfaces';
/**
 ...
 * @public
 */
type Installation<Include extends InstallationInclude = never> = InstallationBase & Included<InstallationInclude, 'activeConfig', Include, {
...
export { PreviewMedia as $, unpublishDocument as $n, ApplicationInterface as $r, ApplyDocumentActionsOptions as $t, loadMoreUsers as A, DocumentAction as An, updateComment as Ar, organizations as At, parseQueryKey as B, UnscheduleReleaseAction as Bn, ClientStoreState as Br, InstallationInclude as Bt, slicePath$1 as C, Selector as Ci, Action as Cn, ReplyToCommentOptions as Cr, SanityUser as Ct, getCorsErrorProjectId as D, DeleteDocumentAction as Dn, removeComment as Dr, UsersStoreState as Dt, isImportError as E, CreateReleaseAction as En, createComment as Er, UsersGroupState as Et, getActiveReleasesState as F, PublishReleaseAction as Fn, CommentStatus as Fr, organization as Ft, getProjectionState as G, deleteRelease as Gn, observeOrganizationVerificationState as Gr, installations as Gt, ProjectsOptions as H, createDocument as Hn, getClientState as Hr, InstallationsOptions as Ht, getAllReleasesState as I, ReleaseAction as In, CommentTextSelection as Ir, Installation as It, ProjectMember as J, editRelease as Jn, Application as Jr, SetFavoriteInput as Jt, Project as K, discardDocument as Kn, OrgVerificationResult as Kr, FavoriteDocumentContext as Kt, QueryOptions as L, ScheduleReleaseAction as Ln, CommentTextSelectionItem as Lr, InstallationAccess as Lt, resolveUsers as M, EditDocumentOptions as Mn, CommentLocalState as Mr, OrganizationBase as Mt, getPerspectiveState as N, EditReleaseAction as Nn, CommentMessage as Nr, OrganizationMember as Nt, getUserState as O, DeleteReleaseAction as On, replyToComment as Or, Organizations as Ot, ReleaseState as P, PublishDocumentAction as Pn, CommentReaction as Pr, OrganizationOptions as Pt, project as Q, unarchiveRelease as Qn, ApplicationInclude as Qr, ActionsResult as Qt, getQueryKey as R, UnarchiveReleaseAction as Rn, CommentThread as Rr, InstallationActiveConfig as Rt, jsonMatch$1 as S, defineMutation as Si, JsonMatch as Sn, RemoveCommentOptions as Sr, ResolveUsersOptions as St, CORE_SDK_VERSION as T, BoundStoreAction as Ti, CreateDocumentAction as Tn, UpdateCommentOptions as Tr, UserProfile as Tt, projects as U, createRelease as Un, logout as Ur, InstallationsResponse as Ut, resolveQuery as V, archiveRelease as Vn, getClient as Vr, InstallationInterface as Vt, resolveProjection as W, deleteDocument as Wn, handleAuthCallback as Wr, installation as Wt, ProjectMetadata as X, publishRelease as Xn, ApplicationBase as Xr, setFavorite as Xt, ProjectMemberRole as Y, publishDocument as Yn, ApplicationAccess as Yr, favorites as Yt, ProjectOptions as Z, scheduleRelease as Zn, ApplicationDeployment as Zr, getReleaseDocumentId as Zt, SanityDocument$3 as _, FetcherDefinition as _i, resolveDocument as _n, getCommentsState as _r, UserPresence as _t, LoggedOutAuthState as a, DeleteApplicationInput as ai, DocumentEditedEvent as an, LogLevel as ar, reportPresence as at, getPathDepth as b, MutationResult as bi, DocumentPermissionsResult as bn, resolveComments as br, Membership as bt, getCurrentUserState as c, application as ci, DocumentRemotePatchesEvent as cn, LoggerConfig as cr, DocumentPresenceOptions as ct, getLoginUrlState as d, updateApplication as di, TransactionAcceptedEvent as dn, createDocumentTypeHandle as dr, PresenceSelection as dt, ApplicationStudioConfig as ei, applyDocumentActions as en, unscheduleRelease as er, PreviewQueryResult as et, getTokenState as f, AccessResourceType as fi, TransactionRevertedEvent as fn, createProjectHandle as fr, PresenceSelectionPoint as ft, Role as g, Fetcher as gi, getPermissionsState as gn, getCommentsOptionsKey as gr, TransportEvent as gt, ReleaseDocument$1 as h, CacheWriter as hi, getDocumentSyncStatus as hn, getCommentThreadsState as hr, StateEvent as ht, LoggedInAuthState as i, ApplicationsResponse as ii, DocumentDiscardedEvent as in, LogContext as ir, getPresence as it, resolveUser as j, EditDocumentAction as jn, Comment as jr, Organization as jt, getUsersState as k, DiscardDocumentAction as kn, setCommentStatus as kr, OrganizationsOptions as kt, getDashboardOrganizationId as l, applications as li, DocumentTransactionSubmissionResult as ln, createDatasetHandle as lr, PresenceLocation as lt, CurrentUser$1 as m, CacheTag as mi, getDocumentState as mn, ResolveCommentsOptions as mr, RollCallEvent as mt, AuthStoreState as n, ApplicationWorkspace as ni, DocumentCreatedEvent as nn, configureLogging as nr, ProjectionValuePending as nt, LoggingInAuthState as o, DeletedResult as oi, DocumentEvent as on, LogNamespace as or, DisconnectEvent as ot, setAuthToken as p, checkPermissions as pi, DocumentOptions as pn, CommentsOptions as pr, ReportPresenceOptions as pt, ProjectBase as q, editDocument as qn, AuthStateType as qr, FavoriteStatusResponse as qt, ErrorAuthState as r, ApplicationsOptions as ri, DocumentDeletedEvent as rn, InstanceContext as rr, getDocumentPresence as rt, getAuthState as s, UpdateApplicationInput as si, DocumentPublishedEvent as sn, Logger as sr, DocumentPresence as st, AuthState as t, ApplicationVisibility as ti, ActionErrorEvent as tn, datasets as tr, PreviewValue as tt, getIsInDashboardState as u, deleteApplication as ui, DocumentUnpublishedEvent as un, createDocumentHandle as ur, PresencePerspectiveOptions as ut, SanityProject$1 as v, FetcherSnapshot as vi, resolvePermissions as vn, parseCommentsOptionsKey as vr, GetUserOptions as vt, stringifyPath$1 as w, StateSource as wi, ArchiveReleaseAction as wn, SetCommentStatusOptions as wr, SanityUserResponse as wt, joinPaths as x, defineFetcher as xi, PermissionDeniedReason as xn, CreateCommentOptions as xr, ResolveUserOptions as xt, getIndexForKey$1 as y, MutationDefinition as yi, subscribeDocumentEvents as yn, resolveCommentThreads as yr, GetUsersOptions as yt, getQueryState as z, UnpublishDocumentAction as zn, ClientOptions as zr, InstallationBase as zt };
//# sourceMappingURL=authStore-C0o1NOxW.d.ts.map