...
/** @public */
export declare class MessageBusError extends Error {
 ...
 * @public
 */
declare type MessageBusErrorCode =
  | "NO_RESPONDER"
  | "TIMEOUT"
  | "ABORTED"
  | "HANDLER_THREW"
 ...
 * @public
 */
export declare interface StateSource<T> extends Observable<T> {
 ...
 * @public
 */
export declare type StateTopic = {
  [K in TopicName]: Topics[K] extends {
    kind: "state";
  }
    ? K
 ...
 * @public
 */
export declare type TopicResult<T> =
  | {
      ok: true;
      value: T;
    }
 ...
 * @public
 */
export declare type ValueOf<K extends StateTopic> =
