...
import { exitCodes, ProjectRootNotFoundError, SanityCommand, subdebug } from '@sanity/cli-core';
...
export class MediaDeployAspectCommand extends SanityCommand {
    ...
    async run() {
        ...
        if (!all && !aspectName) {
            this.error('Aspect name is required. Pass it as the `<aspectName>` argument, or pass `--all`.', {
