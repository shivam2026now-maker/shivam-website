//#region node_modules/sanity/lib/resources-CttFu-Y-.js
/**
...
var variantsLocaleStrings = {
	...
	"overview.action.delete-variant.permission-error": "You do not have permission to delete this variant definition",
	...
	"dialog.create.variant-title.duplicate": "A variant definition with this title already exists: <VariantLink>{{title}}</VariantLink>",
	...
	"dialog.create.conditions.duplicate": "A variant definition with the same conditions already exists: <VariantLink>{{title}}</VariantLink>",
...
//#endregion
export { variantsLocaleStrings as default };
