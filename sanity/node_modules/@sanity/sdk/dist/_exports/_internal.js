import { C as isStudioConfig, O as createLogger, _ as getClientErrorApiDescription, g as getClientErrorApiBody, k as __exportAll, n as getClient, v as getClientErrorApiType, x as isProjectUserNotFoundClientError } from "../clientStore-gUALQ0qW.js";
import { i as pickProperties, n as isObject, t as isDeepEqual } from "../object-BwynGPRZ.js";
import { G as defineMutation, K as randomId, S as getCommentsOptionsKey, W as defineFetcher, d as getUsersKey, i as parseQueryKey, n as getQueryKey, p as parseUsersKey, q as randomUuid, t as CORE_SDK_VERSION, w as parseCommentsOptionsKey } from "../version-C90rNWaX.js";
...
function initTelemetry(instance, projectId) {
	...
	telemetryManagers.has(instance) || initInFlight.has(instance) || (initInFlight.add(instance), logger.debug("initializing telemetry", {
		...
		import("../clientStore-gUALQ0qW.js").then((n) => n.t),
		import("../clientStore-gUALQ0qW.js").then((n) => n.a)
...
function createGroqSearchFilter(query) {
	...
	return finalIncrementalToken !== void 0 && !isPrefixToken(finalIncrementalToken) && processedTokens.splice(finalIncrementalTokenIndex, 1, `${finalIncrementalToken}*`), `[@] match text::query("${processedTokens.join(" ").replace(/"/g, "\\\"")}")`;
}
export { PREVIEW_PROJECTION, createGroqSearchFilter, defineFetcher, defineMutation, getClientErrorApiBody, getClientErrorApiDescription, getClientErrorApiType, getCommentsOptionsKey, getQueryKey, getTelemetryManager, getUsersKey, initTelemetry, isDeepEqual, isProjectUserNotFoundClientError, isStudioConfig, parseCommentsOptionsKey, parseQueryKey, parseUsersKey, pickProperties, randomId, randomUuid, trackHookMounted, transformProjectionToPreview };
