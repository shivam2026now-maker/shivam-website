import type { DurableStepPhase } from './utils/types.js';
...
export declare const SANITY_FUNCTION_PUBSUB = "sanity.function.pubsub";
...
export declare const SANITY_FUNCTION_DURABLE = "sanity.function.durable";
...
export declare const SANITY_STUDIO = "sanity.studio";
...
export declare const EVENT_PUBSUB = "pub-sub";
...
export declare const MAP_EVENT_TO_FUNCTION_TYPE: {
    ...
    readonly "pub-sub": "sanity.function.pubsub";
...
export declare const LABEL_PUBSUB = "PubSub";
export declare const LABEL_SCHEDULED = "Scheduled";
export declare const LABEL_SYNC_TAG_INVALIDATE = "Sync Tag Invalidate";
export declare const CI_SETUP_DOCS_URL = "https://www.sanity.io/docs/blueprints/deploy-blueprints-from-ci";
export declare const STEP_PHASE_GLYPH: Record<DurableStepPhase, string>;
/** Stands in for environment variable values, which are never echoed back to the user */
export declare const ENV_MASK = "********";
