...
export async function getStack({ stackId, auth, fetchFn, }) {
    try {
...
export async function updateStack({ stackId, stackMutation, auth, fetchFn, }) {
    try {
        const response = await fetchFn(`${stacksUrl}/${stackId}`, {
            method: 'PUT',
            headers: getHeaders(auth),
