...
//#region node_modules/@sanity/vision/lib/resources-CIlR0qy4.js
/**
...
var visionLocaleStrings = defineLocalesResources("vision", {
	...
	*/
	...
	"query.error.unsupported-release-perspective": "This API version does not support complex perspectives. Use {{apiVersion}} or later.",
	/** Extra explanation when a 400 is returned for a variant on an incompatible API version */
	"query.error.unsupported-variant": "This API version does not support content variants. Use the experimental API version ({{apiVersion}}).",
	...
	*/
	...
	"save-query.share-warning": "Shared queries are stored as documents in your dataset and count toward your document quota.",
	...
	"settings.api-version-locked-for-variant": "When a variant is selected, the API version needs to be vX.",
