...
import { a as ServerError, c as isHttpError, i as CorsOriginError, l as isQueryParseError, o as formatQueryParseError, r as ClientError, t as defineRequester } from "./request-DXOkY5MQ.js";
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await import("./browserUpload-QxCD0Hp6.js"), req = _prepareRequest(client, { ...baseRequest });
...
var name = "@sanity/client", version = "8.6.1";
