...
export default function Home() {
  ...
  return (
    <main className="overflow-hidden bg-[#050816] text-white">
      ...
      {/* HERO */}
      <section id="home" className="relative h-[170vh] overflow-hidden bg-[#050816]">
        <div className="sticky top-0 h-screen overflow-hidden">
          <div className="absolute inset-0">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{
                backgroundImage: "linear-gradient(to bottom, rgba(5,8,22,0.08), rgba(5,8,22,0.28) 55%, rgba(5,8,22,0.82) 100%), url('/images/hero.jpg')"
              }}
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#050816]/65 via-[#050816]/25 to-transparent" />
          </div>
          ...
          <div className="absolute inset-x-0 bottom-0 z-10">
            <div className="mx-auto max-w-6xl px-6 pb-20 sm:pb-24">
              ...
              <p className="mt-8 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
                Exploring science, engineering, space, and the ideas that could shape what comes next.
              </p>

              <div className="mt-10 flex flex-wrap gap-4">
                <a href="#about" className="rounded-full bg-cyan-400 px-7 py-3.5 font-semibold text-slate-950 transition hover:bg-cyan-300">
                  About me ↓
                </a>
                <a href="#research" className="rounded-full border border-white/30 bg-black/10 px-7 py-3.5 font-semibold text-white backdrop-blur-sm transition hover:border-cyan-400/70">
                  Explore research
                </a>
              </div>

              <div className="mt-16 flex items-center gap-4 text-xs uppercase tracking-[0.25em] text-white/50">
      ...
      <section id="about" className="border-t border-white/10 bg-[#070b1c]">
        <div className="mx-auto max-w-6xl px-6 py-28 sm:py-36">
          <div className="max-w-5xl">
            ...
            <div className="mt-10 space-y-7 text-lg leading-8 text-slate-300 sm:text-xl sm:leading-9">
              <p>
