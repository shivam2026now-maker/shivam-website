...
import { $l as require_compiler_runtime, $n as TrashIcon, Bl as map, Da as useLayer, Dr as SearchIcon, Gi as Portal, Ia as ft, Ka as WarningOutlineIcon, Kl as innerFrom, La as gt, Ls as AppIdCacheContext, Nr as ClockIcon, Oa as useMediaIndex, Pa as Et, Pn as AddIcon, Ti as useGlobalKeyDown, Ui as useClickOutsideEvent, Vn as UnknownIcon, Wa as rem, Wo as isObjectSchemaType, Wr as Badge, Xi as TextInput, Xl as createOperatorSubscriber, bi as ChevronDownIcon, bt as SortIcon, fa as SpinnerIcon, fi as studioTheme, gi as CheckmarkIcon, gs as getPublishedId, ha as Text, ma as Stack, ml as SearchContext, no as isNonNullable, oo as removeDupes, pr as ArrowLeftIcon, qr as Container, sa as CloseIcon, ua as Button, vt as ControlsIcon, wi as Inline, xr as ErrorOutlineIcon, ya as Card, zr as ChevronRightIcon } from "./DoubleChevronRight-T9pMBEMy.js";
import { $a as useActorRef, $f as isArguments, $n as defineSearchMachine, Af as omit, Ai as supportsTouch, Al as useValuePreview, Ao as intersection, Ap as useClient, Bp as createDebug, Cl as useDocumentVersions, Dp as DEFAULT_STUDIO_CLIENT_OPTIONS, Ed as useKeyValueStore, Fc as SanityDefaultPreview, Ff as difference, Fm as createObject, G as DocumentVersionsStatus, Gf as _getTag_default, Im as argsArgArrayOrObject, Jf as isPrototype, K as DocumentVersionsStatusIndicator, Kf as isArrayLike, Ks as es2015_default, Kt as PreviewCard$1, Lp as defineEvent, Mf as dequal, Mp as useWorkspace, Od as useProjectStore, Oo as Code, Qf as isArray, Rf as uniq, Rl as useCurrentUser, Sd as useDocumentPreviewStore, Tf as partition, Tr as getPreviewStateObservable, U as DocumentPreviewPresence, Vl as Translate, Vn as createSearch, Vp as enabled, Wl as TextWithTone, Xf as isBuffer, Yf as isTypedArray, Yi as useDocumentPresence, Yu as isRecord$2, _m as startWith, ac as Popover$1, dp as useTelemetry, eo as useSelector, ep as useObservable, fc as truncateString, hl as useActiveReleases, jd as useSchema, jp as useSource, kd as useRenderingContextStore, np as useSyncObservable, om as fromObservable, q as EMPTY_ARRAY$10, qf as baseKeys, sp as AnimatePresence, wd as useGrantsStore, xa as useSearchMaxFieldDepth, xf as startCase, yo as useIntentLink } from "./PerspectiveProvider-DPuh6brq-CckVPauS.js";
import { L as useTranslation$1, O as motion, S as Flex, a as MenuItem$1, b as Box, d as MenuDivider, i as MenuButton$1, l as Menu, n as ErrorBoundary$1, s as Tooltip$1, t as Button$1 } from "./Tab-Dx6d0Ug4-CJ6dKjFB.js";
import { t as Observable } from "./Observable-dfeu5CEH.js";
import { t as Subject } from "./Subject-Bs90HcI7.js";
import { F as tap, G as merge, at as of, et as mapOneOrManyArgs, ot as popResultSelector } from "./clientStore-gUALQ0qW-abMnnZtK.js";
...
var require_react_dom_server_legacy_browser_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		function pushStartInstance(target$jscomp$0, type, props, resumableState, renderState, preambleState, hoistableState, formatContext, textEmbedded) {
			...
			switch (type) {
				...
				case "meta":
					...
					else textEmbedded && target$jscomp$0.push("<!-- -->"), JSCompiler_inline_result$jscomp$8 = isFallback$jscomp$1 ? null : "string" === typeof props.charSet ? pushSelfClosing(renderState.charsetChunks, props, "meta", formatContext) : "viewport" === props.name ? pushSelfClosing(renderState.viewportChunks, props, "meta", formatContext) : pushSelfClosing(renderState.hoistableChunks, props, "meta", formatContext);
			...
			if ("function" === typeof type) if (type.prototype && type.prototype.isReactComponent) {
				...
				if (null === segment) {
					...
					if ((task.formatContext = getChildFormatContext(_prevContext2, type, props)).insertionMode === HTML_HEAD_MODE) {
						...
						try {
							renderNode(request, task, _children, -1), pushSegmentFinale(preambleSegment.chunks, request.renderState, preambleSegment.lastPushedText, preambleSegment.textEmbedded), preambleSegment.status = COMPLETED;
						} finally {
				...
				if (keyOrIndex === node[1]) {
					if (4 === node.length) {
						...
						a: {
							...
							var fallbackAbortSet = /* @__PURE__ */ new Set(), resumedBoundary = createSuspenseBoundary(replay, task.row, fallbackAbortSet, null, !1);
		...
		function flushSegment(request, destination, segment, hoistableState) {
			...
			if (boundary.status === CLIENT_RENDERED) {
				...
				if (!request.renderState.generateStaticMarkup) {
					...
					null != errorDigest && (destination.push(clientRenderedSuspenseBoundaryError1A), errorDigest = escapeTextForBrowser(errorDigest), destination.push(errorDigest), destination.push(clientRenderedSuspenseBoundaryErrorAttrInterstitial));
			...
			try {
				if (!(0 < request.pendingRootTasks)) {
					...
					for (i = 0; i < clientRenderedBoundaries.length; i++) {
						...
						if (null != errorDigest || errorMessage || errorStack || errorComponentStack) if (renderState$jscomp$1.push(clientRenderErrorScriptArgInterstitial), null == errorDigest) renderState$jscomp$1.push(clientRenderErrorScriptNull);
						else {
		...
		function renderToStringImpl(children, options, generateStaticMarkup, abortReason) {
			...
			children = createRequest(children, options, createRenderState(options, generateStaticMarkup), createFormatContext(ROOT_HTML_MODE, null, 0, null), Infinity, onError, void 0, void 0, function() {
				readyToStream = !0;
		...
		var REACT_RECOVERABLE_DIGEST = "", CLIENT_RENDERED = 4, PENDING = 0, COMPLETED = 1, FLUSHED = 2, ABORTED = 3, ERRORED = 4, POSTPONED = 5, CLOSED = 13, RENDER_ENDED = "The render ended.", currentRequest = null, didWarnAboutBadClass = {}, didWarnAboutContextTypes = {}, didWarnAboutContextTypeOnFunctionComponent = {}, didWarnAboutGetDerivedStateOnFunctionComponent = {}, didWarnAboutReassigningProps = !1, didWarnAboutGenerators = !1, didWarnAboutMaps = !1, flushedByteSize = 0, flushingPartialBoundaries = !1;
...
var require_react_dom_server_browser_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		function fatalError(request, error, errorInfo, debugTask) {
			...
			debugTask ? (shellComplete || debugTask.run(errorInfo.bind(null, error)), debugTask.run(onFatalError.bind(null, error))) : (shellComplete || errorInfo(error), onFatalError(error));
			endRenderLifetime(request);
			null !== request.destination ? (request.status = CLOSED, closeWithError(request.destination, error)) : (request.status = 12, request.aborted || (request.fatalError = error));
		}
		function finishSuspenseListRow(request, row) {
			unblockSuspenseListRow(request, row.next, row.hoistables);
		}
		...
		function flushSegment(request, destination, segment, hoistableState) {
			...
			if (boundary.status === CLIENT_RENDERED) {
				...
				null != row && (writeChunk(destination, clientRenderedSuspenseBoundaryError1A), writeChunk(destination, stringToChunk(escapeTextForBrowser(row))), writeChunk(destination, clientRenderedSuspenseBoundaryErrorAttrInterstitial));
			...
			try {
				if (!(0 < request.pendingRootTasks)) {
					...
					for (i = 0; i < clientRenderedBoundaries.length; i++) {
						...
						if (null != errorDigest || errorMessage || errorStack || errorComponentStack) writeChunk(renderState$jscomp$1, clientRenderErrorScriptArgInterstitial), null == errorDigest ? writeChunk(renderState$jscomp$1, clientRenderErrorScriptNull) : writeChunk(renderState$jscomp$1, stringToChunk(escapeJSStringsForInstructionScripts(errorDigest)));
				...
				flushingPartialBoundaries = !1, i = request.postponedState, null !== i && (i.nextSegmentId = request.nextSegmentId), 0 === request.allPendingTasks && 0 === request.clientRenderedBoundaries.length && 0 === request.completedBoundaries.length ? (request.flushScheduled = !1, i = request.resumableState, i.hasBody && writeChunk(destination, endChunkForTag("body")), i.hasHtml && writeChunk(destination, endChunkForTag("html")), completeWriting(destination), 0 !== request.abortableTasks.size && console.error("There was still abortable task at the root when we closed. This is a bug in React."), endRenderLifetime(request), request.status = CLOSED, destination.close(), request.destination = null) : completeWriting(destination);
			}
		}
		function startWork(request) {
			request.flushScheduled = null !== request.destination;
		...
		function startFlowing(request, destination) {
			if (12 === request.status) request.status = CLOSED, request = request.fatalError, isRecoverableError(request) && (request = cloneRecoverableErrorAsFatal(request)), closeWithError(destination, request);
			else if (request.status !== CLOSED && null === request.destination) {
				request.destination = destination;
				try {
					flushCompletedQueues(request, destination);
		...
		var React = require_react(), ReactDOM = require_react_dom(), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_CONSUMER_TYPE = Symbol.for("react.consumer"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), REACT_SUSPENSE_TYPE = Symbol.for("react.suspense"), REACT_SUSPENSE_LIST_TYPE = Symbol.for("react.suspense_list"), REACT_MEMO_TYPE = Symbol.for("react.memo"), REACT_LAZY_TYPE = Symbol.for("react.lazy"), REACT_SCOPE_TYPE = Symbol.for("react.scope"), REACT_ACTIVITY_TYPE = Symbol.for("react.activity"), REACT_LEGACY_HIDDEN_TYPE = Symbol.for("react.legacy_hidden"), REACT_MEMO_CACHE_SENTINEL = Symbol.for("react.memo_cache_sentinel"), REACT_VIEW_TRANSITION_TYPE = Symbol.for("react.view_transition"), REACT_RECOVERABLE_TYPE = Symbol.for("react.recoverable"), MAYBE_ITERATOR_SYMBOL = Symbol.iterator, ASYNC_ITERATOR = Symbol.asyncIterator, REACT_OPTIMISTIC_KEY = Symbol.for("react.optimistic_key"), isArrayImpl = Array.isArray, jsxPropsParents = /* @__PURE__ */ new WeakMap(), jsxChildrenParents = /* @__PURE__ */ new WeakMap(), CLIENT_REFERENCE_TAG = Symbol.for("react.client.reference"), channel = new MessageChannel(), taskQueue = [];
...
//#endregion
//#region node_modules/sanity/lib/SearchProvider-BNZac-WA.js
...
//#endregion
export { isHotkey as A, isStaging as C, useSearchState as D, useSearch as E, useStudioAppIdStore as O, hasSearchableTerms as S, useRenderingContext as T, getPreviewValueWithFallback as _, RecentSearches as a, getSearchableTypes as b, SearchProvider as c, SearchResults as d, SearchWrapper as f, getDocumentTypesTruncated as g, defineSearchFilterOperators as h, GLOBAL_SEARCH_KEY_MODIFIER as i, forkJoin as j, require_server_browser as k, SearchResultItem as l, defineSearchFilter as m, CustomTextInput as n, SearchHeader as o, StatusButton as p, Filters as r, SearchPopover as s, AppIdCacheProvider as t, SearchResultItemPreview as u, getSanityImportMapUrl as v, useProjectOrganizationId as w, hasSanityPackageInImportMap as x, getSchemaField as y };
