import { ValueOf, PlaybackCore, MuxMediaProps, MuxMediaPropsInternal, MuxMediaPropTypes, MuxMediaState } from './types';
...
export { mux, Hls, MediaError, MuxErrorCategory, MuxErrorCode, errorCategoryToTokenNameOrPrefix, MuxJWTAud, addTextTrack, removeTextTrack, getTextTrack, addCuePoints, getCuePoints, getActiveCuePoint, setupCuePoints, addChapters, getChapters, getActiveChapter, setupChapters, getStartDate, getCurrentPdt, toPlaybackIdParts, i18n, parseJwt, MinCapLevelController, };
export * from './types';
 ...
 */
export declare const getMediaPlaylistFromMultivariantPlaylist: (multivariantPlaylist: string, masterPlaylistUrl?: string | URL) => Promise<string>;
export declare const getMultivariantPlaylistSessionData: (playlist: string) => {
    sessionData?: undefined;
} | {
    sessionData: Record<string, Record<string, string>>;
};
export declare function parseTagAttributes(str: string): {
    [k: string]: string;
};
export declare const getStreamInfoFromPlaylist: (playlist: string) => {
...
export declare const fetchAndDispatchMuxMetadata: (metadataUrl: string, mediaEl: HTMLMediaElement) => Promise<void>;
...
export declare const muxMediaState: MuxMediaState;
export declare const generatePlayerInitTime: () => number | undefined;
...
export declare const getMetadata: (mediaEl: HTMLMediaElement) => Partial<import("mux-embed").Metadata | undefined>;
...
export declare const getCoreReference: (mediaEl: HTMLMediaElement) => PlaybackCore | undefined;
 ...
 */
export declare const clearMuxDataCookies: () => void;
/**
 ...
 */
export declare const reinitMuxData: (props: Partial<MuxMediaPropsInternal>, mediaEl?: HTMLMediaElement | null, core?: PlaybackCore) => void;
/**
 ...
 */
export declare const applyDisableCookies: (props: Partial<MuxMediaPropsInternal>, mediaEl?: HTMLMediaElement | null, core?: PlaybackCore) => void;
export declare const teardown: (mediaEl?: HTMLMediaElement | null, core?: PlaybackCore, props?: Partial<MuxMediaPropsInternal>) => void;
export declare const setupHls: (props: Partial<Pick<MuxMediaPropsInternal, "debug" | "streamType" | "type" | "startTime" | "metadata" | "preferCmcd" | "_hlsConfig" | "tokens" | "drmTypeCb" | "maxAutoResolution" | "capRenditionToPlayerSize" | "initialBandwidthEstimateKbps">>, mediaEl: HTMLMediaElement) => Hls | undefined;
...
export declare const setupNativeFairplayDRM: (props: Partial<Pick<MuxMediaPropsInternal, "playbackId" | "tokens" | "playbackToken" | "customDomain" | "drmTypeCb" | "useWebkitFairplay" | "fallbackToWebkitFairplay">>, mediaEl: HTMLMediaElement) => void;
...
export declare const getCapLevelControllerConfig: (props: Pick<MuxMediaPropsInternal, "capRenditionToPlayerSize">, _hlsConfig: Partial<HlsConfig>) => Partial<Pick<HlsConfig, "capLevelController" | "capLevelToPlayerSize">>;
...
export declare const loadMedia: (props: Partial<Pick<MuxMediaProps, "preferPlayback" | "src" | "type" | "startTime" | "streamType" | "autoplay" | "playbackId" | "tokens" | "customDomain" | "disablePseudoEnded" | "maxReconnectRetries" | "debug" | "useWebkitFairplay" | "fallbackToWebkitFairplay">>, mediaEl: HTMLMediaElement, hls?: Pick<Hls, "config" | "on" | "once" | "off" | "trigger" | "startLoad" | "stopLoad" | "recoverMediaError" | "destroy" | "loadSource" | "attachMedia" | "liveSyncPosition" | "subtitleTracks" | "subtitleTrack" | "userConfig" | "audioTrack" | "audioTracks" | "autoLevelEnabled" | "nextLevel" | "levels" | "currentLevel">) => void;
