import { $i as StoreRequestErrorHandler, $s as UploaderResolver, An as GetHookCollectionStateProps, Ao as InputProps, As as FieldError, Ba as CookielessCompatibleLoginMethod, Bo as RenderAnnotationCallback, Br as FieldChangeNode, Bs as ObjectItemProps, Bt as ToolMenuProps, C as FormDocumentValue, Cs as FieldSetMember, Ct as Source, Dl as PreviewLayoutKey, Dn as DocumentBadgeComponent, Dr as AnnotationDetails, Dt as Tool, Eo as BooleanInputProps, Er as Annotation, Fa as AuthStore, Fi as DocumentStoreExtraOptions, Fr as Diff$1, Ft as LogoProps, Ga as LocaleDefinition, Go as RenderInputCallback, H as Config, Hi as IdPair, Ho as RenderArrayOfPrimitivesItemCallback, Hr as FromToIndex, Ic as FormFieldGroup, Ir as DiffComponent, J as DocumentActionsVersionType, Ja as LocaleResourceBundle, Jc as PresenceLocation, Jo as RenderPreviewCallbackProps, Kc as DocumentPresence, Ko as RenderItemCallback, Lr as DiffComponentOptions, Lt as NavbarProps, Mn as DocumentActionComponent, Mo as ObjectInputProps, Mr as ChangeTitlePath, Mt as WorkspaceSummary, Nr as Chunk, Ol as PreviewMediaDimensions, Os as ArrayItemError, Ot as Workspace, Pa as AuthState, Po as OnPathFocusPayload, Qc as DocumentFieldAction, Ra as AuthConfig, Rc as FormNodePresence, Rs as ItemProps, So as ArrayOfObjectsInputProps, Ss as FieldMember, St as SingleWorkspace, Ts as ObjectMember, U as ConfigContext$1, Uo as RenderBlockCallback, Ur as GroupChangeNode, Va as LoginMethod, Vi as DocumentPairTarget, Vn as DocumentActionProps, Vo as RenderArrayOfObjectsItemCallback, Vs as PrimitiveItemProps, W as ConfigPropertyReducer, Wo as RenderFieldCallback, Wr as ItemDiff$1, Xn as OperationsAPI, Xr as StringDiffSegment, Yr as StringDiff$1, Za as LocaleSource, Zt as DocumentPreviewStore, _n as PreviewableType, _r as Pair, _s as ArrayOfObjectsItemMember, aa as Template, ac as ReleasesNavMenuItemPropsGetter, ar as TimelineController, c as PatchChannel, cc as SystemVariant, ci as DocumentGroupEvent, cl as DocumentFieldActionsResolverContext, di as EventsStore, ei as FieldValueError, er as HistoryStore, g as StateTree, go as FieldCommentsProps, gt as PreparedConfig, hc as SystemBundle, hl as FormPatch, hn as PreviewPath, hr as DocumentVersionEvent, ht as PluginOptions, ic as ReleaseId, in as DocumentAvailability, ir as SelectionState, ji as EditStateFor, jo as NumberInputProps, jr as ChangeNode, ki as DocumentVariantType, kl as PreviewProps, li as DocumentVersionEventType, ll as PatchEvent, ls as NodeChronologyProps, lt as MissingConfigFile, mt as Plugin, na as StudioTheme, nc as PerspectiveContextValue, ni as StudioLocaleResourceKeys, no as TFunction$2, p as FormState, pr as CommitError, qc as GlobalPresence, qo as RenderPreviewCallback, qr as ObjectDiff$1, qt as ValidationStatus, ra as StudioThemeColorSchemeKey, rc as PerspectiveStack, rl as DocumentFieldActionNode, ro as ArrayInputFunctionsProps, sc as TargetPerspective, sn as DraftsModelDocumentAvailability, tc as PerspectiveBundle, vl as FormPatchOrigin, vr as RemoteSnapshotVersionEvent, vs as ArrayOfObjectsMember, wl as GeneralPreviewLayoutKey, wo as ArrayOfPrimitivesInputProps, wt as SourceClientOptions, xt as SchemaPluginOptions, yn as ObserveDocumentAPIConfig, ys as ArrayOfPrimitivesItemMember, zo as StringInputProps, zs as ObjectItem } from "./useVirtualizerScrollInstance-DrjJlJI9.js";
import { A as CommandListHandle, An as GrantsStore, C as SearchStrategyFactory, Cn as UserListWithPermissionsHookValue, Ct as TagValue, Dn as DocumentValuePermission, F as ScheduleFormData, Gt as CommentsContextValue, Ht as CommentsSelectedPathContextValue, I as RouterHistory, L as ConnectorContextValue, Ln as AddonDatasetContextValue, M as CommandListProps, Q as ReactHook, Qt as CommentBaseCreatePayload, Rn as ActiveWorkspaceMatcherContextValue, T as WeightedSearchResults, Ut as CommentsEnabledContextValue$1, Vt as CommentsSelectedPath, Wt as CommentsEnabledContextValue, X as PartialExcept, Z as LoadingTuple, Zt as CommentsType$1, _n as CommentUpdatePayload, _t as FormBuilderContextValue, a as WorkspaceAuthStates, an as CommentMessage, bn as CommentsType, c as UserColorHue, d as RequestErrorChannel, f as RequestErrorClaim, fn as CommentStatus, g as StudioAnnouncementDocument, h as DialogMode, hn as CommentThreadItem, jn as PermissionCheckResult, kn as Grant, kt as DocumentChangeContextInstance, l as UserColorManager, m as StudioErrorHandler, mn as CommentTextSelection, n as WorkspacesContextValue, r as VisibleWorkspacesContextValue, rn as CommentIntentGetter, s as UserColor, st as ParseError, t as ZIndexContextValue, tn as CommentDocument, un as CommentReactionOption, v as SearchContextValue, vt as BaseFeedbackTags, wt as ConsentStatus, xn as CommentsUIMode, y as Groq2024SearchResults, yn as CommentsTextSelectionItem, yt as DynamicFeedbackTags } from "./types-BC0I9wF8.js";
import { F as RelativeTimeOptions, d as ProjectGrants, l as ProjectData, p as ProjectStore, u as ProjectDatasetData } from "./FIXME-CzYxbgTZ.js";
import { CSSProperties, Component, ComponentProps, ComponentType, Dispatch, ElementType, ErrorInfo, FC, FormEvent, HTMLAttributes, HTMLProps, KeyboardEvent, PropsWithChildren, PureComponent, ReactElement, ReactNode, Ref, RefAttributes, RefObject, SVGProps, SetStateAction } from "react";
import { MonoTypeOperatorFunction, Observable, OperatorFunction } from "rxjs";
import "@sanity/ui/styles.css";
import { DocumentLimitUpsellContextValue, FeedbackContext as FeedbackContext$1, FieldActionsContextValue, HoveredFieldContextValue, SchedulesContext, SingleDocReleaseContextValue } from "sanity/_singletons";
import { Subscriber } from "nano-pubsub";
import { ArraySchemaType, AssetSource, BooleanSchemaType, ConditionalProperty, CrossDatasetType, CurrentUser, DeprecatedProperty, DocumentSystem, FieldGroup, File, FileAsset, FileSchemaType, FormNodeValidation, I18nTextRecord, Image, ImageAsset, ImageSchemaType, InitialValueProperty, InitialValueResolverContext, NumberSchemaType, ObjectSchemaType, Path, PortableTextBlock, PrepareViewOptions, PreviewValue, Reference, ReferenceSchemaType, Role, SanityDocument, SanityDocumentLike, Schema, SchemaType, SchemaTypeDefinition, SearchStrategy, SlugSchemaType, SlugValue, SortOrdering, StrictVersionLayeringOptions, StringSchemaType, TextSchemaType, UploadState, User, ValidationMarker } from "@sanity/types";
import { AvatarPosition, AvatarProps, AvatarSize, AvatarStatus, BadgeProps, BadgeTone, Button, ButtonProps, ButtonTone, HotkeysProps, Placement, ResponsiveWidthProps, Skeleton, TextProps, ThemeColorSchemeKey } from "@sanity/ui";
import { ExecutionProps } from "styled-components";
import { BoxProps, PaddingProps, Space } from "ui5";
import { TooltipProps } from "@sanity/ui/tooltip";
import { ToastParams } from "@sanity/ui/toast";
import { DocumentHandle } from "@sanity/sdk-react";
import { ClientConfig, ClientPerspective, ReconnectEvent, ReleaseDocument, ReleaseDocument as ReleaseDocument$1, ReleaseType, RequestHandler, ResetEvent, SanityClient, SanityClient as SanityClient$1, SanityDocument as SanityDocument$1, SanityDocumentStub, SingleActionResult, StackablePerspective, WelcomeBackEvent, WelcomeEvent } from "@sanity/client";
import QuickLRU from "quick-lru";
import { Node } from "@sanity/comlink";
import { Rule as ConcreteRuleClass, ValidationContext as ValidationContext$1 } from "@sanity/validation/_internal";
...
import { PopoverProps } from "@sanity/ui/popover";
import { IntentLinkProps, SearchParam } from "sanity/router";
import { EditorSelection, RangeDecoration, RangeDecorationOnMovedDetails } from "@portabletext/editor";
import { MenuButtonProps } from "@sanity/ui/menu";
...
import { getProviderTitle as getProviderTitle$1 } from "@sanity/access-ui";
 ...
 * @internal
 */
declare function CommentDisabledIcon(props: SVGProps<SVGSVGElement> & RefAttributes<SVGSVGElement>): import("react").JSX.Element;
/**
 * @beta
 * @hidden
 */
...
declare function CommentsListInner(props: CommentsListProps & RefAttributes<HTMLUListElement>): import("react").JSX.Element;
/**
 * @beta
 * @hidden
 */
declare const CommentsList: import("react").MemoExoticComponent<typeof CommentsListInner>;
/**
 * @internal
 */
type CommentInputRenderBlock = (props: {
 ...
 * @hidden
 */
declare function CommentInput(props: CommentInputProps & RefAttributes<CommentInputHandle>): import("react").JSX.Element;
 ...
 * @internal
 */
declare function CommentInlineHighlightSpan(props: CommentInlineHighlightSpanProps & React.HTMLProps<HTMLSpanElement> & RefAttributes<HTMLSpanElement>): import("react").JSX.Element;
/**
 * @internal
 * @hidden
 */
 ...
 * @hidden
 */
interface CommentsProviderProps$1 {
  children: ReactNode;
  documentId: string;
  documentType: string;
  /**
 ...
 * @beta
 */
declare const CommentsProvider$1: import("react").MemoExoticComponent<(props: CommentsProviderProps$1) => import("react").JSX.Element>;
interface CommentsEnabledProviderProps$1 {
  children: ReactNode;
  documentId: string;
  documentType: string;
}
 ...
 * @hidden
 */
declare const CommentsEnabledProvider$1: import("react").MemoExoticComponent<(props: CommentsEnabledProviderProps$1) => import("react").JSX.Element>;
/**
 * @beta
 * @hidden
 */
 ...
 * @hidden
 */
declare function useCommentsEnabled$1(): CommentsEnabledContextValue;
/**
 * @internal
 */
 ...
 * @hidden
 */
declare function useCommentsEnabled(): CommentsEnabledContextValue$1;
/** @internal */
...
type Props$4 = PropsWithChildren<{
 ...
 * @internal
 */
declare const CapabilityGate: ComponentType<Props$4>;
/** @internal */
...
/** @internal */
declare function CollapseMenu(props: CollapseMenuProps & RefAttributes<any>): import("react").JSX.Element;
/** @internal */
declare function AutoCollapseMenu(props: Omit<CollapseMenuProps, 'children' | 'collapsed'> & {
  menuOptions: React.JSX.Element[];
} & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function Button$1({ ref, size, mode, paddingY, paddingLeft, tone, tooltipProps, ...rest }: ButtonProps$1 & Omit<HTMLProps<HTMLButtonElement>, 'as' | 'size' | 'title'> & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
/** @internal */
...
/** @internal */
declare function CollapseMenuButton(props: CollapseMenuButtonProps & Omit<HTMLProps<HTMLButtonElement>, 'as' | 'size'> & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
declare function CommandListComponent({ ref, activeItemDataAttr, ariaLabel, ariaMultiselectable, autoFocus, canReceiveFocus, fixedHeight, focusRingOffset, getItemDisabled, getItemKey, getItemSelected, initialIndex, initialScrollAlign, inputElement, itemHeight, items, onEndReached, onEndReachedIndexOffset, onlyShowSelectionWhenActive, overscan, renderItem, testId, wrapAround, ...paddingProps }: CommandListProps & RefAttributes<CommandListHandle>): import("react").JSX.Element;
/**
 ...
 * @internal
 */
declare const CommandList: import("react").MemoExoticComponent<typeof CommandListComponent>;
 ...
 * @internal
 */
declare function ContextMenuButton(props: ContextMenuButtonProps & Pick<HTMLProps<HTMLButtonElement>, 'disabled' | 'hidden' | 'onClick'> & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
/**
 * Renders its children after the given delay has elapsed.
 *
 * @internal
 */
declare function Delay({ children, ms }: {
...
interface DocumentStatusProps$2 {
 ...
 */
declare function DocumentStatus({ draft, published, versions, singleLine }: DocumentStatusProps$2): import("react").JSX.Element;
/**
 ...
 * @internal
 */
declare function DocumentVersionIcons({ version }: {
 ...
 * @internal
 */
declare function DocumentVersionsStatus({ documentGroupId }: {
 ...
 */
declare function DocumentStatusIndicator({ draft, published, versions }: DocumentStatusProps$1): import("react").JSX.Element;
 ...
 * @internal
 */
declare function DocumentVersionsStatusIndicator({ documentVersions }: DocumentStatusProps): import("react").JSX.Element | null;
/**
 * @internal
 */
interface ErrorActionsProps extends Pick<ComponentProps<typeof Button$1>, 'size'> {
  error: unknown;
  eventId?: string | null;
  onRetry?: () => void;
  isRetrying?: boolean;
 ...
 * @public
 */
declare function Hotkeys$1({ makePlatformAware, keys: hotKeys, ...props }: HotkeysProps$1): import("react").JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare function LoadingBlock({ fill, showText, title }: LoadingTestProps): import("react").JSX.Element;
/** @internal */
type PopoverProps$3 = PopoverProps;
interface PopoverDialogProps {
  children: ReactNode;
  header?: ReactNode;
  onClose: () => void;
  referenceElement: PopoverProps$3['referenceElement'];
 ...
 */
declare function Resizable(props: ResizableProps & Omit<BoxProps<ElementType>, 'maxWidth' | 'minWidth'> & Omit<HTMLProps<HTMLDivElement>, 'as'>): import("react").JSX.Element;
/**
 * @hidden
 * @beta */
...
/** @hidden @beta */
declare function StatusButton(props: StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, 'disabled' | 'ref' | 'size' | 'title'> & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
/** @internal */
...
/** @internal */
declare function TextWithTone(props: TextWithToneProps & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/** @internal */
declare function TooltipOfDisabled({ ref, children, content, disabled, ...restProps }: TooltipProps$1 & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/** @internal */
 ...
 */
declare function ImperativeToast({ ref }: {
  ref?: Ref<{
    push: (params: ToastParams$1) => string;
  }>;
}): null;
/** @internal */
 ...
 * @beta
 */
declare const AvatarSkeleton: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components/dist/types").Merged<Omit<import("@sanity/ui").SkeletonProps & Omit<import("react").HTMLProps<HTMLDivElement>, "height">, "style"> & {
  style?: import("react").CSSProperties | import("styled-components/dist/types").CSSPropertiesWithVars | undefined;
}, AvatarSkeletonProps>> & string & Omit<typeof Skeleton, keyof import("react").Component<any, {}, any>>;
/**
 * @hidden
 * @beta */
 ...
 * @internal
 */
declare function getDocumentVersionType(options: {
  isRevision?: boolean;
 ...
 * @internal
 */
interface DocumentGroupInventoryComponents {
 ...
 * @internal
 */
interface DocumentGroupInventoryManageProps extends DocumentGroupInventoryBaseProps {
  mode: 'manage';
  /**
 ...
 * @internal
 */
interface DocumentGroupInventoryReadOnlyProps extends DocumentGroupInventoryBaseProps {
  mode: 'readOnly';
}
/**
 * @internal
 */
type DocumentGroupInventoryProps = DocumentGroupInventoryManageProps | DocumentGroupInventoryReadOnlyProps;
/**
 * @internal
 */
 ...
 */
declare function useDocumentVersionTitle({ version }: {
  version: VersionInfoDocumentStub;
}): {
  title: string;
  fullTitle: string;
...
/** @internal */
declare function DiffCard(props: DiffCardProps & Omit<HTMLProps<HTMLElement>, 'as' | 'height'>): import("react").JSX.Element;
/** @internal */
...
/** @internal */
declare function FromTo(props: FromToProps & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/** @internal */
...
/** @internal */
declare function RevertChangesButton(props: Omit<ButtonProps$1, 'tooltipProps'> & Omit<HTMLProps<HTMLButtonElement>, 'ref'> & {
  changeCount: number;
} & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
...
interface PopoverProps$2 extends SharedProps$1 {
  type: 'popover';
 ...
 */
declare function EditPortal(props: PopoverProps$2 | DialogProps$2): React.JSX.Element;
...
interface PopoverProps$1 extends SharedProps {
  type: 'popover';
  id?: string;
  legacy_referenceElement: HTMLElement | null;
  onClose: () => void;
 ...
 */
declare function EnhancedObjectDialog(props: PopoverProps$1 | DialogProps$1): React.JSX.Element;
/** @internal */
...
/** @internal */
declare function FormFieldSet(props: FormFieldSetProps & Omit<HTMLProps<HTMLDivElement>, 'as' | 'height' | 'ref'> & RefAttributes<HTMLDivElement>): import("react").JSX.Element;
/** @internal */
 ...
 * @internal
 */
declare const FormCell: import("styled-components/dist/types").IStyledComponentBase<"web", import("styled-components/dist/types").Merged<Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "style"> & {
  style?: import("react").CSSProperties | import("styled-components/dist/types").CSSPropertiesWithVars | undefined;
}, Props$3>> & string;
/**
 * @internal
 */
declare const FormContainer: ComponentType<ComponentProps<typeof FormContainerRoot>>;
declare const FormContainerRoot: import("styled-components/dist/types").IStyledComponentBase<"web", Omit<import("react").DetailedHTMLProps<import("react").HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "style"> & {
  style?: import("react").CSSProperties | import("styled-components/dist/types").CSSPropertiesWithVars | undefined;
}> & string;
/**
 *
 ...
 * @beta
 */
declare class ArrayOfPrimitivesInput extends PureComponent<ArrayOfPrimitivesInputProps, State$1> {
 ...
 * @hidden
 * @beta */
declare function DateInput$1(props: DateInputProps): import("react").JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @internal
 */
declare function getPreviewStateObservable(documentPreviewStore: DocumentPreviewStore, schemaType: SchemaType, documentId: string, perspective?: PerspectiveStack, viewOptions?: PrepareViewOptions,
/**
 ...
 */
variant?: string): Observable<PreviewState>;
...
interface Props$2 extends Omit<HTMLProps<HTMLButtonElement>, 'as' | 'size' | 'width' | 'type' | 'ref'> {
  id: string;
 ...
 * @internal
 */
declare function CreateButton(props: Props$2): import("react").JSX.Element;
/**
 * @internal
 */
declare function ReferenceAutocomplete(props: ComponentProps<typeof Autocomplete> & {
  path: Path;
  referenceElement: HTMLDivElement | null;
  searchString?: string;
  portalRef?: RefObject<HTMLDivElement | null>;
} & RefAttributes<HTMLInputElement>): import("react").JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @beta
 */
declare function TextInput$1(props: TextInputProps): import("react").JSX.Element;
/**
 *
 * @hidden
 * @beta
 ...
 * @hidden
 * @beta */
interface BaseFileInputValue extends Partial<File> {
  _upload?: UploadState;
}
/**
 * @hidden
 ...
 * @internal
 */
declare function deriveDocumentSyncState(consistency$: Observable<boolean>, connectionState$: Observable<ConnectionState>, commitFailed$: Observable<boolean>): Observable<DocumentSyncState>;
/** @internal */
 ...
 * @beta
 */
interface CreatableTargetDocument {
 ...
 * @beta
 */
interface TargetDocumentSiblings {
  published: VersionInfoDocumentStub | undefined;
  draft: VersionInfoDocumentStub | undefined;
 ...
 * @beta
 */
declare function getCreatableVariantTarget(state: TargetDocumentState): CreatableTargetDocument | undefined;
/**
 ...
 * @beta
 */
declare function getTargetSiblings(state: TargetDocumentState): TargetDocumentSiblings | undefined;
/**
 ...
 * @internal
 */
interface TargetScopeIdOptions {
 ...
 * @internal
 */
declare function useTargetScopeId(options: TargetScopeIdOptions): string | undefined;
/**
 *
 * @hidden
 * @beta
 ...
 * @internal
 */
declare const ReleasesNav: ComponentType<Props$1>;
 ...
 * @internal
 */
declare function useSetPerspective(): (releaseId: SystemBundle | ReleaseId | undefined) => void;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function Chip(props: ComponentProps<typeof Button>): import("react").JSX.Element;
/**
 * @internal
 */
...
declare const ReleaseAvatarIcon: ({ tone, release, releaseType, size }: ReleaseAvatarIconProps) => import("react").JSX.Element;
...
interface VersionOperationsValue {
  createVersion: (releaseId: ReleaseId, documentId: string, options?: CreateVersionOptions) => Promise<void>;
  /**
 ...
 * @internal
 */
declare function useAllReleases(): {
  data: ReleaseDocument[];
  error?: Error;
  loading: boolean;
 ...
 * @internal
 */
declare function getReleaseDocumentIdFromReleaseId(releaseId: string): string;
/**
 * @internal
 ...
 * @internal
 */
declare function EditScheduleForm(props: PropsWithChildren<Props>): import("react").JSX.Element;
/**
 * @deprecated we will be dropping support for scheduled publishing on a future major version
 * @beta
 */
 ...
 * @hidden
 */
interface SearchMachineContext<TQuery, TResult> {
  debounceMs: number;
  error: Error | null;
  query: TQuery | null;
  result: TResult | null;
 ...
 * @hidden
 */
type SearchMachineEvent<TQuery> = {
  type: 'search';
  query: TQuery;
};
/**
 ...
 * @hidden
 */
type SearchMachineEmitted<TResult> = {
  type: 'search started';
} | {
 ...
 * @hidden
 */
declare function defineSearchMachine<TQuery, TResult>(): import("xstate").StateMachine<SearchMachineContext<TQuery, TResult>, SearchMachineEvent<TQuery>, {
  [x: string]: import("xstate").ActorRefFromLogic<import("xstate").ObservableActorLogic<TResult, {
    query: TQuery;
  }, import("xstate").EventObject>> | undefined;
}, {
  src: "search";
  logic: import("xstate").ObservableActorLogic<TResult, {
    query: TQuery;
  ...
  type: "should search";
  params: unknown;
}, "debounce", "debouncing" | "failure" | "idle" | "skipped" | "success" | {
  searching: "pending" | "streaming";
}, string, SearchMachineInput, import("xstate").NonReducibleUnknown, {
  type: 'search started';
} | {
  type: 'search completed';
  result: TResult;
 ...
 * @hidden
 */
interface SearchMachineState<THit> {
  hits: THit[];
  isLoading: boolean;
  searchString?: string;
}
 ...
 * @hidden
 */
interface UseSearchMachineOptions<THit> {
 ...
 * @hidden
 */
declare function useSearchMachine<THit>(options: UseSearchMachineOptions<THit>): {
...
/** @internal */
declare function useGlobalPresence(): GlobalPresenceEntry[];
/**
...
/** @internal */
declare function useProject(): ProjectData | null;
/** @internal */
 ...
 * @internal
 */
declare function useColorSchemeOptions(setScheme: (nextScheme: StudioThemeColorSchemeKey) => void, t: TFunction$2<'studio'>): ColorSchemeOption[];
/** @internal */
interface ApiNetworkResourceTiming {
  connectionMs: number;
...
/** @internal */
interface ApiNetworkDiagnostic {
  durationMs: number;
  error?: string;
  protocol: string;
...
/** @internal */
interface SchemaDiagnostics {
  documentTypes: number;
  objectTypes: number;
  primitiveTypes: number;
}
/** @internal */
interface StyleSheetDiagnostic {
...
/** @internal */
interface RequestPerformanceTarget {
  dataset: string;
  projectId: string;
}
/** @internal */
interface RequestPerformanceEntry extends RequestPerformanceTarget {
  apiVersion: string;
  bucket: string;
  durationMs: number;
  startedAt: string;
...
/** @internal */
interface RequestPerformanceBucketSummary {
  bucket: string;
  count: number;
  maxMs: number;
  medianMs: number;
...
/** @internal */
interface RequestPerformanceSessionSummary {
  buckets: RequestPerformanceBucketSummary[];
  startedAt: string;
  totalRequests: number;
}
/** @internal */
interface RequestPerformanceSnapshot extends RequestPerformanceTarget {
...
/** @internal */
declare function DiagnosticsReport({ diagnostics, onRunAgain, runAgainLabel }: DiagnosticsReportProps): import("react").JSX.Element;
/**
 * @internal
 */
 ...
 * @internal
 */
declare function SearchHeader({ ref, ariaInputLabel, onClose }: SearchHeaderProps & RefAttributes<HTMLInputElement>): import("react").JSX.Element;
 ...
 * @internal
 */
declare function SearchPopover({ disableFocusLock, disableIntentLink, onClose, onItemSelect, onOpen, previewPerspective, previewVariant, open }: SearchPopoverProps): import("react").JSX.Element;
 ...
 * @internal
 */
declare function SearchResultItemPreview({ documentId, documentType, layout, presence, schemaType, showBadge, perspective, variant }: SearchResultItemPreviewProps): import("react").JSX.Element;
 ...
 * @internal
 */
declare function SearchButton({ ref, onClick }: SearchButtonProps & RefAttributes<HTMLButtonElement>): import("react").JSX.Element;
 ...
 * @internal
 */
declare function SearchDialog({ onClose, onOpen, open, previewPerspective, previewVariant }: SearchDialogProps): import("react").JSX.Element;
/**
 * @hidden
 * @beta */
 ...
 * @hidden
 * @beta */
declare function ToolLink(props: ToolLinkProps & Omit<HTMLProps<HTMLAnchorElement>, 'href' | 'name'> & RefAttributes<HTMLAnchorElement>): import("react").JSX.Element;
/**
 ...
 * @internal
 */
declare function parseStudioDiagnostics(input: string): StudioDiagnostics;
/** @internal */
interface StudioDiagnosticsBridgeApi {
  gather: (options?: {
    requestTimeout?: number;
 ...
 * @internal
 */
declare function StudioDiagnosticsBridge(): null;
/** @internal */
 ...
 * @hidden
 */
declare function IsLastPaneProvider({ children, isLastPane }: IsLastPaneProviderProps): React.JSX.Element;
 ...
 * @internal
 */
declare const formatRelativeLocale: (date: DateInput, baseDate: DateInput, timeZone?: string) => string;
/**
 ...
 * @internal
 */
declare function useShallowUnique<ValueType>(value: ValueType): ValueType;
/**
 * @internal
 *
 * @example
 ...
 * @beta
 */
declare function useCreatableVariantInitialValue(targetDocumentState: TargetDocumentState, fallback: InitialValueState): InitialValueState;
type BaseOptions = {
  client: SanityClient;
 ...
 * @internal
 */
type CreateVariantScopedDocumentOptions = BaseOptions & ({
...
declare function useVariantDocumentOperations(): {
  createVariantDocument: (options: DistributiveOmit<CreateVariantScopedDocumentOptions, 'client'>) => Promise<SingleActionResult>;
};
/**
 * Gets all variants.
 * @internal
...
export { isArray as $, isDocumentLimitError as $a, FieldActionsProvider as $c, ScrollContextValue as $d, CollapseMenuProps as $f, isPublishedPerspective as $i, DiffErrorBoundary as $l, matchWorkspace as $n, DocumentIdStack as $o, useProjectStore as $r, MemberFieldError as $s, StudioAnnouncementsDialog as $t, createAuthStore as $u, useShallowUnique as A, getPreviewValueWithFallback as Aa, EmailInput as Ac, InitialValueOptions as Ad, Hotkeys$1 as Af, SingleDocReleaseProvider as Ai, ValueError as Al, SearchProvider as An, useSyncState as Ao, ChangeConnectorRootProps as Ap, useInitialValue as Ar, FormProvider as As, validateBasePaths as At, FeedbackDialogProps as Au, _isSanityDocumentTypeDefinition as B, PresenceScope as Ba, ArrayOfPrimitivesInput as Bc, operationEvents as Bd, DocumentVersionsStatus as Bf, createSearch as Bi, FieldChange as Bl, ColorSchemeLocalStorageProvider as Bn, useManageFavorite as Bo, useLoadable as Br, useParseErrorForPath as Bs, ConfigErrorGate as Bt, getConfigContextFromSource as Bu, isDraftVersion as C, getVersionInlineBadge as Ca, ReferenceAutocomplete as Cc, DocumentStore as Cd, CompactPreview as Cf, createMockAuthStore as Ci, emptyValuesByType as Cl, StudioNavbar as Cn, TargetDocumentState as Co, CommentInput as Cp, getDocumentPairPermissions as Cr, isObjectInputProps as Cs, defaultTemplateForType as Ct, useFeedback as Cu, readVersionType as D, VersionChip as Da, ObjectInput as Dc, ListenQueryOptions as Dd, IntentButton as Df, useScheduledDraftsEnabled as Di, isRemovedItemDiff as Dl, PartialIndexSettings as Dn, getTargetSiblings as Do, CommentDisabledIcon as Dp, EventsProvider as Dr, StudioImageInput as Ds, IsLastPaneProvider as Dt, StudioFeedbackDialog as Du, isVariantVersion as E, ReleaseAvatarIcon as Ea, getPreviewStateObservable as Ec, createDocumentStore as Ed, LoadingBlock as Ef, isAgentBundleName as Ei, isGroupChange as El, SearchButton as En, getTargetScopeId as Eo, CommentsList as Ep, useEventsStore as Er, ImageInputProps as Es, useDocumentPreviewValues as Et, useInStudioFeedback as Eu, supportsTouch as F, useUnstableObserveDocument as Fa, DateInput$1 as Fc, InitialValueState as Fd, ErrorWithId as Ff, SearchMachineContext as Fi, MetaInfoProps as Fl, Filters as Fn, useReconnectingToast as Fo, useNavigateToCanvasDoc as Fp, ErrorState as Fr, defaultRenderInlineBlock as Fs, useVisibleWorkspaces as Ft, DocumentGroupInventory as Fu, isCardinalityOneRelease as G, useSetPerspective as Ga, ArrayOfObjectsInput as Gc, ZIndexContextValueKey as Gd, Delay as Gf, createSchema as Gi, DiffTooltipWithAnnotationsProps as Gl, useColorSchemeOptions as Gn, FormattedDuration as Go, useComlinkStore as Gr, ALL_FIELDS_GROUP as Gs, InterpolationProp as Gt, createSourceFromConfig as Gu, createSWR as H, DocumentPreviewPresence as Ha, ArrayOfPrimitiveOptionsInput as Hc, UserAvatar as Hd, DocumentStatus as Hf, getSearchableTypes as Hi, Event$1 as Hl, ColorSchemeProviderProps as Hn, useListFormat as Ho, useDocumentType as Hr, useReportParseError as Hs, useWorkspaceLoader as Ht, SchemaError as Hu, escapeField as I, SanityDefaultPreview as Ia, DateInputProps as Ic, type InitialValueSuccessMsg as Id, ErrorActions as If, SearchMachineEmitted as Ii, FromToArrow as Il, DiagnosticsReport as In, useProjectId as Io, useCanvasCompanionDoc as Ip, LoadableState as Ir, defaultRenderInput as Is, getNamelessWorkspaceIdentifier as It, DocumentGroupInventoryProps as Iu, measureFirstMatch as J, useExcludedPerspective as Ja, useHoveredField as Jc, TooltipOfDisabled as Jd, CollapseMenuButton as Jf, useScheduleAction as Ji, DiffInspectWrapper as Jl, useAddonDataset as Jn, useFilteredReleases as Jo, useDocumentStore as Jr, ObjectMembers as Js, StudioProvider as Jt, prepareConfig as Ju, isPausedCardinalityOneRelease as K, usePerspective as Ka, ArrayOfObjectsFunctions as Kc, ImperativeToast as Kd, ContextMenuButton as Kf, SchedulesContext as Ki, DiffString as Kl, useColorSchemeSetValue as Kn, UseFormattedDurationOptions as Ko, useConnectionStatusStore as Kr, resolveConditionalProperty as Ks, UpsellDescriptionSerializer as Kt, createWorkspaceFromConfig as Ku, fieldNeedsEscape as L, SanityDefaultPreviewProps as La, CrossDatasetReferencePreview as Lc, OperationError as Ld, ErrorActionsProps as Lf, SearchMachineEvent as Li, FromToArrowDirection as Ll, DiagnosticsReportProps as Ln, UseNumberFormatOptions as Lo, LoadedState as Lr, defaultRenderItem as Ls, getWorkspaceIdentifier as Lt, DocumentGroupInventoryComponents as Lu, sliceString as M, unstable_useValuePreview as Ma, getCalendarLabels as Mc, InitialValueErrorMsg as Md, GetHookCollectionState as Mf, SearchMachineState as Mi, RevertChangesButton as Ml, SearchPopover as Mn, useReviewChanges as Mo, ChangeIndicatorProps as Mp, selectUpstreamVersion as Mr, defaultRenderAnnotation as Ms, validateWorkspaces as Mt, isProd as Mu, truncateString as N, useValuePreview as Na, DateTimeInput as Nc, InitialValueLoadingMsg as Nd, serializeError as Nf, UseSearchMachineOptions as Ni, NoChanges as Nl, SearchPopoverProps as Nn, DocumentField as No, ChangeFieldWrapper as Np, isNewDocument as Nr, defaultRenderBlock as Ns, useWorkspaces as Nt, useDocumentVersionTitle as Nu, useUnique as O, Chip as Oa, NumberInput as Oc, ListenQueryParams as Od, InsufficientPermissionsMessage as Of, useScheduledDraftDocument as Oi, isUnchangedDiff as Ol, useSearchMaxFieldDepth as On, useTargetDocumentState as Oo, CommentDeleteDialog as Op, useEvents as Or, FileInputProps as Os, DEFAULT_STUDIO_CLIENT_OPTIONS as Ot, StudioFeedbackDialogProps as Ou, uncaughtErrorHandler as P, unstable_useObserveDocument as Pa, DateTimeInputProps as Pc, InitialValueMsg as Pd, useCopyErrorDetails as Pf, useSearchMachine as Pi, MetaInfo as Pl, SearchHeader as Pn, useReferringDocuments as Po, getDocumentIdForCanvasLink as Pp, useDocumentValues as Pr, defaultRenderField as Ps, evaluateWorkspaceHidden as Pt, DocumentGroupInventoryAction as Pu, isNonNullable as Q, getSelectedVariant as Qa, FieldActionsResolver as Qc, StatusButtonProps as Qd, CollapseMenu as Qf, isDraftPerspective as Qi, FieldPreviewComponent as Ql, MatchWorkspaceResult as Qn, useDocumentOperation as Qo, usePresenceStore as Qr, MemberFieldSet as Qs, isValidAnnouncementRole as Qt, _createAuthStore as Qu, joinPath as R, PreviewLoader as Ra, BooleanInput as Rc, OperationSuccess as Rd, DocumentVersionsStatusIndicator as Rf, SearchMachineInput as Ri, FromTo as Rl, StudioDiagnostics as Rn, useNumberFormat as Ro, LoadingState as Rr, defaultRenderPreview as Rs, WorkspaceLike as Rt, DocumentGroupInventoryPerspectiveList as Ru, VersionType as S, VersionInlineBadge as Sa, SelectInput as Sc, WithReferringDocuments as Sd, DefaultPreviewProps as Sf, MockAuthStoreOptions as Si, useDocumentChange as Sl, StudioToolMenu as Sn, CreatableTargetDocument as So, CommentInlineHighlightSpan as Sp, DocumentPermission as Sr, isNumberInputProps as Ss, resolveInitialValueForType as St, UseFeedbackReturn as Su, isReleaseVersion as T, ReleaseAvatar as Ta, CreateReferenceOption as Tc, QueryParams$1 as Td, PopoverDialog as Tf, useAgentVersionDisplay as Ti, isFieldChange as Tl, SearchDialog as Tn, getPairTarget as To, CommentInputProps as Tp, useDocumentPairPermissionsFromHookFactory as Tr, isStringInputProps as Ts, prepareTemplates as Tt, UseInStudioFeedbackReturn as Tu, CardinalityOneRelease as U, DocumentPreviewPresenceProps as Ua, ArrayOfOptionsInput as Uc, UserAvatarProps as Ud, VersionInfoDocumentStub as Uf, compileFieldPath as Ui, DiffTooltip as Ul, useColorScheme as Un, GlobalCopyPasteElementHandler as Uo, validation as Ur, createSanityMediaLibraryFileSource as Us, ErrorMessage as Ut, resolveSchemaTypes as Uu, _isType as V, PresenceScopeProps as Va, ArrayOfPrimitivesFunctions as Vc, AvatarSkeleton as Vd, DocumentVersionIcons as Vf, isPerspectiveRaw as Vi, FallbackDiff as Vl, ColorSchemeProvider as Vn, UseListFormatOptions as Vo, DocumentTypeResolveState as Vr, useParseErrors as Vs, WorkspaceLoaderBoundary as Vt, useConfigContextFromSource as Vu, isCardinalityOnePerspective as W, useSetVariant as Wa, ArrayOfObjectOptionsInput as Wc, LegacyLayerProvider as Wd, isReleaseDocument as Wf, getSchemaTypeTitle as Wi, DiffTooltipProps as Wl, useColorSchemeInternalValue as Wn, useGlobalCopyPasteElementHandler as Wo, remoteSnapshots as Wr, createSanityMediaLibraryImageSource as Ws, ErrorMessageProps as Wt, CreateWorkspaceFromConfigOptions as Wu, isString as X, PerspectiveNotWriteableReason as Xa, useFieldActions as Xc, TextWithToneProps as Xd, CommonProps as Xf, formatRelativeLocalePublishDate as Xi, DiffFromTo as Xl, useActiveWorkspace as Xn, useEditState as Xo, useHistoryStore as Xr, ObjectInputMember as Xs, StudioLayoutComponent as Xt, CreateAuthStoreOptions as Xu, isTruthy as Y, ReleasesNav as Ya, HoveredFieldProvider as Yc, TextWithTone as Yd, CollapseMenuButtonProps as Yf, EditScheduleForm as Yi, DiffInspectWrapperProps as Yl, AddonDatasetProvider as Yn, useFeatureEnabled as Yo, useGrantsStore as Yr, ObjectMembersProps as Ys, StudioProviderProps as Yt, AuthStoreOptions as Yu, isRecord as Z, isPerspectiveWriteable as Za, FieldActionsProps as Zc, StatusButton as Zd, AutoCollapseMenu as Zf, getDocumentIsInPerspective as Zi, DiffFromToProps as Zl, MatchWorkspaceOptions as Zn, useDocumentOperationEvent as Zo, useKeyValueStore as Zr, ObjectInputMemberProps as Zs, isValidAnnouncementAudience as Zt, RequestFailureDiagnostics as Zu, getVariantTitle as _, useOnlyHasVersions as _a, TagsArrayInput as _c, ConfigPropertyError as _d, MediaPreview as _f, RetryingStatus as _i, FormField as _l, StudioDiagnosticsBridge as _n, TimeAgoOpts as _o, CommentsIntentProviderProps as _p, grantsPermissionOn as _r, useConnectionState as _s, RESOLVE_INITIAL_VALUE_TIMEOUT_MS as _t, getAnnotationColor as _u, DEFAULT_LIST_TYPES as a, getReleaseIdFromReleaseDocumentId as aa, ArrayOfObjectsItem as ac, documentFieldActionsReducer as ad, Resizable as af, UserStore as ai, FormCell as al, useRetryCountdown as an, defineLocaleResourceBundle as ao, CommentsProvider as ap, useProject as ar, decodePath as as, formatRelativeLocale as at, ChangeTitleSegment as au, useCreatableVariantInitialValue as b, useDocumentVersionTypeSortedList as ba, SlugInput as bc, ZIndexProvider as bd, DetailPreviewProps as bf, isAuthStore as bi, EditPortal as bl, ToolLink as bn, TargetScopeIdOptions as bo, CommentsAuthoringPathProvider as bp, useDocumentValuePermissions as br, isArrayOfPrimitivesInputProps as bs, resolveInitialObjectValue as bt, useStudioFeedbackTags as bu, ReleaseDocument$1 as c, PUBLISHED as ca, ArrayOfObjectsInputMembersProps as cc, getDocumentVersionType as cd, LinearProgress as cf, KeyValueStore as ci, FormFieldValidationError as cl, renderStudio as cn, ValidationLocaleResourceKeys as co, buildCommentRangeDecorations as cp, useGlobalPresence as cr, fromMutationPatches as cs, UserColorManagerProviderProps as ct, ChangeResolverProps as cu, TFunction$1 as d, useArchivedReleases as da, UrlInput as dc, definePlugin as dd, TemplatePreviewProps as df, ConnectedStatus as di, FormFieldValidationStatus as dl, GenerateStudioManifestOptions as dn, useValidationStatus as do, useCommentsEnabled$1 as dp, useTimelineSelector as dr, useDocumentForm as ds, useUserColor as dt, ChangeListProps as du, isReleaseScheduledOrScheduling as ea, MemberField as ec, CorsCheckResult as ed, ScrollEventHandler as ef, useRenderingContextStore as ei, FieldActionMenu as el, StudioAnnouncementsCard as en, useDocumentLimitsUpsellContext as eo, CapabilityGate as ep, ActiveWorkspaceMatcher as er, useDocumentIdStack as es, globalScope as et, DiffErrorBoundaryProps as eu, ValidationContext$1 as f, useAllReleases as fa, UrlInputProps as fc, createConfig as fd, InlinePreview as ff, ConnectingStatus as fi, FormFieldValidationStatusProps as fl, generateStudioManifest as fn, FormattableMeasurementUnit as fo, useComments as fp, TimelineState as fr, DocumentSyncState as fs, useUserColorManager as ft, ChangeBreadcrumb as fu, SANITY_VERSION as g, useVersionOperations as ga, TelephoneInputProps as gc, ConfigResolutionErrorOptions as gd, BlockImagePreviewProps as gf, ErrorStatus as gi, FormFieldSetProps as gl, StudioFeedbackProvider as gn, useTools as go, CommentsIntentProvider as gp, createGrantsStore as gr, connectionState as gs, DEFAULT_MAX_RECURSION_DEPTH as gt, getAnnotationAtPath as gu, getProviderTitle$1 as h, sortReleases as ha, TelephoneInput as hc, ConfigResolutionError as hd, BlockImagePreview as hf, ConnectionStatusStoreOptions as hi, FormFieldSet as hl, StudioWorkspaceManifest as hn, useUnitFormatter as ho, CommentsSelectedPathProvider as hp, GrantsStoreOptions as hr, ConnectionState as hs, LegacyThemeTints as ht, DiffVisitor as hu, DEFAULT_DECORATORS as i, getReleaseTone as ia, PrimitiveMemberItemProps as ic, flattenConfig as id, RovingFocusProps as if, createPresenceStore as ii, FormContainer as il, RequestErrorDialog as in, defineLocale as io, CommentsEnabledProvider as ip, useProjectDatasets as ir, useClient as is, getErrorMessage as it, TIMELINE_ITEM_I18N_KEY_MAPPING as iu, userHasRole as j, getPreviewPaths as ja, EmailInputProps as jc, getInitialValueStream as jd, HotkeysProps$1 as jf, useSingleDocRelease as ji, RevertChangesConfirmDialog as jl, SearchResultItemPreview as jn, useStudioUrl as jo, ChangeIndicator as jp, useInitialValueResolverContext as jr, FormProviderProps as js, validateNames as jt, isDev as ju, useThrottledCallback as k, prepareForPreview as ka, AssetAccessPolicy as kc, listenQuery as kd, InsufficientPermissionsMessageProps as kf, usePausedScheduledDraft as ki, noop as kl, useSearchState as kn, SyncState as ko, ChangeConnectorRoot as kp, useResolveInitialValueForType as kr, StudioFileInput as ks, ValidateWorkspaceOptions as kt, FeedbackDialog as ku, ResetEvent as l, useReleasesIds as la, ArrayOfObjectsInputMember as lc, PluginFactory as ld, CircularProgress as lf, KeyValueStoreValue as li, FormFieldValidationInfo as ll, uploadSchema as ln, useWorkspaceSchemaId as lo, useCommentsTelemetry as lp, useDocumentPresence as lr, toMutationPatches as ls, UserColorManagerOptions as lt, GroupChange as lu, WelcomeEvent as m, RELEASES_INTENT as ma, TextInputProps as mc, createDefaultIcon as md, BlockPreview as mf, ConnectionStatusStore as mi, FormFieldStatus as ml, StudioManifest as mn, UseUnitFormatterOptions as mo, isTextSelectionComment as mp, useTimelineStore as mr, useDocumentSyncState as ms, LegacyThemeProps as mt, useDiffAnnotationColor as mu, DEFAULT_ANNOTATIONS as n, isReleasePerspective as na, MemberItemError as nc, WorkspacesProvider as nd, useRovingFocus as nf, PresenceStore as ni, GetFormValueProvider as nl, StudioProps as nn, I18nNode as no, BetaBadgeProps as np, useCurrentUser as nr, useDataset as ns, getVariantPublishedSibling as nt, DiffCard as nu, ImageUrlBuilder$1 as o, getReleaseDocumentIdFromReleaseId as oa, MemberItemProps as oc, defineDocumentFieldAction as od, RelativeTime as of, UserStoreOptions as oi, FormRow as ol, createRequestErrorChannel as on, defineLocalesResources as oo, buildTextSelectionFromFragment as op, createProjectStore as or, encodePath as os, catchWithCount as ot, ChangesError as ou, WelcomeBackEvent as p, useActiveReleases as pa, TextInput$1 as pc, defineConfig as pd, InlinePreviewProps as pf, ConnectionStatus as pi, FieldStatusProps as pl, ManifestWorkspaceInput as pn, UnitFormatter as po, hasCommentMessageValue as pp, TimelineStore as pr, deriveDocumentSyncState as ps, buildLegacyTheme as pt, useAnnotationColor as pu, measureFirstEmission as q, useGetDefaultPerspective as qa, useDidUpdate as qc, ToastParams$1 as qd, CommandList as qf, ScheduledBadge as qi, DiffStringSegment as ql, useColorSchemeValue as qn, useFormattedDuration as qo, useDocumentPreviewStore as qr, ObjectInputMembers as qs, useTelemetryConsent as qt, resolveConfig as qu, DEFAULT_BLOCK_STYLES as r, isGoingToUnpublish as ra, ArrayOfPrimitivesItem as rc, WorkspacesProviderProps as rd, RovingFocusNavigationType as rf, SESSION_ID as ri, useGetFormValue as rl, useStudioErrorHandler as rn, useI18nText as ro, useCommentsEnabled as rp, useUser as rr, useConditionalToast as rs, getReferencePaths as rt, DiffCardProps as ru, ReconnectEvent as s, LATEST as sa, ArrayOfObjectsInputMembers as sc, initialDocumentFieldActions as sd, RelativeTimeProps as sf, createUserStore as si, FormFieldValidation as sl, passthroughErrorHandler as sn, removeUndefinedLocaleResources as so, buildRangeDecorationSelectionsFromComments as sp, getProjectGrants as sr, MutationPatch as ss, UserColorManagerProvider as st, ChangeResolver as su, ConcreteRuleClass as t, RELEASES_STUDIO_CLIENT_OPTIONS as ta, MemberFieldProps as tc, CorsProbeOutcome as td, useOnScroll as tf, useUserStore as ti, FieldActionMenuProps as tl, Studio as tn, useGetI18nText as to, BetaBadge as tp, ActiveWorkspaceMatcherProps as tr, useDialogStack as ts, getTargetDocument as tt, DiffErrorBoundaryState as tu, SanityClient$1 as u, useDocumentVersionInfo as ua, ArrayOfObjectsMemberProps as uc, createPlugin as ud, TemplatePreview as uf, CONNECTING as ui, FormFieldValidationWarning as ul, LiveManifestRegisterProvider as un, useVersionRelease as uo, useCommentsSelectedPath as up, createKeyValueStore as ur, useFormBuilder as us, createUserColorManager as ut, ChangeList as uu, useAllVariants as v, useIsReleaseActive as va, TagsArrayInputProps as vc, ConfigPropertyErrorOptions as vd, MediaPreviewProps as vf, createConnectionStatusStore as vi, FormFieldProps as vl, StudioDiagnosticsBridgeApi as vn, useTimeAgo as vo, CommentsEnabledProvider$1 as vp, DocumentValuePermissionsOptions as vr, isArrayOfBlocksInputProps as vs, Serializeable as vt, getDiffAtPath as vu, isPublishedVersion as w, ReleaseTitle as wa, CreateButton as wc, DocumentStoreOptions as wd, CompactPreviewProps as wf, AgentVersionDisplay as wi, isAddedItemDiff as wl, StudioLogo as wn, getCreatableVariantTarget as wo, CommentInputHandle as wp, useDocumentPairPermissions as wr, isObjectItemProps as ws, defaultTemplatesForSchema as wt, SendFeedbackOptions as wu, isDocumentInSelectedVariant as x, useDocumentVersions as xa, SlugInputProps as xc, useZIndex as xd, DefaultPreview as xf, isCookielessCompatibleLoginMethod as xi, resolveDiffComponent as xl, ToolLinkProps as xn, useTargetScopeId as xo, COMMENTS_INSPECTOR_NAME as xp, DocumentPairPermissionsOptions as xr, isBooleanInputProps as xs, resolveInitialValue as xt, FeedbackContext$1 as xu, useVariantDocumentOperations as y, useFormatRelativeLocalePublishDate as ya, StringInput as yc, useMiddlewareComponents as yd, DetailPreview as yf, onRetry as yi, EnhancedObjectDialog as yl, parseStudioDiagnostics as yn, useTemplates as yo, CommentsProvider$1 as yp, getDocumentValuePermissions as yr, isArrayOfObjectsInputProps as ys, isBuilder as yt, visitDiff as yu, _isCustomDocumentTypeDefinition as z, Preview as za, UniversalArrayInput as zc, emitOperation as zd, DocumentStatusIndicator as zf, defineSearchMachine as zi, FromToProps as zl, ColorSchemeCustomProvider as zn, UseManageFavoriteProps as zo, asLoadable as zr, ParseErrorsProvider as zs, CorsOriginErrorScreen as zt, DocumentGroupInventoryReferencePreviewLinkProps as zu };
//# sourceMappingURL=index-BA4-Rq55.d.ts.map