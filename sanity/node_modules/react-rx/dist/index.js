...
function getOrCreateStore(observable, shouldWarmUp) {
	...
	let state = { didEmit: !1 }, entry = {
		...
		getSnapshot: (fallback) => {
			...
			return state.didEmit ? state.snapshot : fallback;
		},
		warmedUp: !1
	};
...
function useObservable(observable, initialValue, t0) {
	let $ = c(20), { disabled: t1 } = t0 === void 0 ? EMPTY_OBJECT : t0, disabled = t1 !== void 0 && t1, [hasInitialValue] = useState(initialValue !== void 0), [resolvedInitialValue] = useState(initialValue), [tracker] = useState(_temp$3), t2;
	...
	$[13] !== instance || $[14] !== resolvedInitialValue ? (t5 = () => instance.getSnapshot(resolvedInitialValue), t6 = () => instance.getSnapshot(resolvedInitialValue), $[13] = instance, $[14] = resolvedInitialValue, $[15] = t5, $[16] = t6) : (t5 = $[15], t6 = $[16]);
...
function useObservableSubject() {
	let [observableSubject] = useState(_temp$2);
...
function useObservableEvent(handleEvent) {
	let $ = c(7), [events$, emit] = useObservableSubject(), t0;
	$[0] === handleEvent ? t0 = $[1] : (t0 = (observable) => handleEvent(observable), $[0] = handleEvent, $[1] = t0);
	let onEvent = useEffectEvent(t0), t1;
	$[2] !== events$ || $[3] !== onEvent ? (t1 = () => {
		let subscription = events$.pipe(onEvent).subscribe();
		return () => subscription.unsubscribe();
	}, $[2] = events$, $[3] = onEvent, $[4] = t1) : t1 = $[4];
	let t2;
	return $[5] === events$ ? t2 = $[6] : (t2 = [events$], $[5] = events$, $[6] = t2), useEffect(t1, t2), emit;
}
/**
...
function useSyncObservable(observable, initialValue, t0) {
	let $ = c(19), { disabled: t1 } = t0 === void 0 ? EMPTY_OBJECT : t0, disabled = t1 !== void 0 && t1, [hasInitialValue] = useState(initialValue !== void 0), [resolvedInitialValue] = useState(initialValue), [tracker] = useState(_temp), t2;
	$[0] !== disabled || $[1] !== hasInitialValue || $[2] !== observable || $[3] !== tracker ? (t2 = needsWarmUp(tracker, observable, hasInitialValue, disabled), $[0] = disabled, $[1] = hasInitialValue, $[2] = observable, $[3] = tracker, $[4] = t2) : t2 = $[4];
	let shouldWarmUp = t2, t3;
	$[5] !== observable || $[6] !== shouldWarmUp ? (t3 = getOrCreateStore(observable, shouldWarmUp), $[5] = observable, $[6] = shouldWarmUp, $[7] = t3) : t3 = $[7];
	let instance = t3, t4;
	...
	let subscribe = t4, t5;
	$[13] !== instance || $[14] !== resolvedInitialValue ? (t5 = () => instance.getSnapshot(resolvedInitialValue), $[13] = instance, $[14] = resolvedInitialValue, $[15] = t5) : t5 = $[15];
	let t6;
	return $[16] !== hasInitialValue || $[17] !== resolvedInitialValue ? (t6 = hasInitialValue ? () => resolvedInitialValue : void 0, $[16] = hasInitialValue, $[17] = resolvedInitialValue, $[18] = t6) : t6 = $[18], useSyncExternalStore(subscribe, t5, t6);
}
function _temp2() {}
function _temp() {
	return { last: null };
}
export { DEFAULT_HOOK_TTL, DEFAULT_PRELOAD_TTL, preloadObservablePromise, useObservable, useObservableEvent, useObservablePromise, useObservableSubject, useSyncObservable };
