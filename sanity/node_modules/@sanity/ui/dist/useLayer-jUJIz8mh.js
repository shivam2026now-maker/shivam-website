import { a as rem, i as _responsive, n as _getArrayProp, o as EMPTY_ARRAY, r as _getResponsiveSpace, s as EMPTY_RECORD } from "./helpers-C8xxXAQC.js";
...
const StyledBox = /* @__PURE__ */ styled.div.withConfig({
	...
	let t30 = asProp, t31;
	return $[79] !== props.children || $[80] !== ref || $[81] !== restProps || $[82] !== t10 || $[83] !== t11 || $[84] !== t12 || $[85] !== t13 || $[86] !== t14 || $[87] !== t15 || $[88] !== t16 || $[89] !== t17 || $[90] !== t18 || $[91] !== t19 || $[92] !== t20 || $[93] !== t21 || $[94] !== t22 || $[95] !== t23 || $[96] !== t24 || $[97] !== t25 || $[98] !== t26 || $[99] !== t27 || $[100] !== t28 || $[101] !== t29 || $[102] !== t30 || $[103] !== t4 || $[104] !== t5 || $[105] !== t6 || $[106] !== t7 || $[107] !== t8 || $[108] !== t9 ? (t31 = /* @__PURE__ */ jsx(StyledBox, {
		"data-as": t4,
		"data-ui": "Box",
		...restProps,
		$column: t5,
...
function CardComponent(props) {
	...
	$[32] !== as || $[33] !== checkered || $[34] !== focusRing || $[35] !== ref || $[36] !== restProps || $[37] !== rootTheme.scheme || $[38] !== selected || $[39] !== t10 || $[40] !== t11 || $[41] !== t12 || $[42] !== t13 || $[43] !== t14 || $[44] !== t15 || $[45] !== t16 || $[46] !== t4 || $[47] !== t6 || $[48] !== t7 || $[49] !== t8 || $[50] !== t9 || $[51] !== tone ? (t17 = /* @__PURE__ */ jsx(StyledCard, {
		"data-as": t4,
		"data-scheme": t5,
		"data-ui": "Card",
		"data-tone": tone,
	...
	let t18;
	return $[53] !== scheme || $[54] !== t17 || $[55] !== tone ? (t18 = /* @__PURE__ */ jsx(ThemeColorProvider, {
		scheme,
		tone,
		children: t17
...
function LayerProvider(props) {
	let $ = c(20), { children, zOffset: t0 } = props, zOffsetProp = t0 === void 0 ? 0 : t0, parentContextValue = useContext(LayerContext), t1;
	...
	$[5] === parentRegisterChild ? t4 = $[6] : (t4 = (childLevel) => {
	...
	}, $[5] = parentRegisterChild, $[6] = t4);
	let registerChild = t4, t5, t6;
	$[7] !== level || $[8] !== parentRegisterChild ? (t5 = () => parentRegisterChild?.(level), t6 = [level, parentRegisterChild], $[7] = level, $[8] = parentRegisterChild, $[9] = t5, $[10] = t6) : (t5 = $[9], t6 = $[10]), useEffect(t5, t6);
	let t7;
	$[11] !== isTopLayer || $[12] !== level || $[13] !== registerChild || $[14] !== size || $[15] !== zIndex ? (t7 = {
		version: 0,
		isTopLayer,
		level,
		registerChild,
		size,
		zIndex
	}, $[11] = isTopLayer, $[12] = level, $[13] = registerChild, $[14] = size, $[15] = zIndex, $[16] = t7) : t7 = $[16];
	let value = t7, t8;
	return $[17] !== children || $[18] !== value ? (t8 = /* @__PURE__ */ jsx(LayerContext.Provider, {
		value,
		children
	}), $[17] = children, $[18] = value, $[19] = t8) : t8 = $[19], t8;
}
function _temp2(v_0) {
	return v_0 - 1;
}
...
//# sourceMappingURL=useLayer-jUJIz8mh.js.map