 ...
 * ```
 */
declare function IntentLink(props: IntentLinkProps & HTMLProps<HTMLAnchorElement> & RefAttributes<HTMLAnchorElement>): import("react").JSX.Element;
/**
 ...
 * ```
 */
declare function Link(props: LinkProps & HTMLProps<HTMLAnchorElement> & RefAttributes<HTMLAnchorElement>): import("react").JSX.Element;
/**
 * @public
 */
 ...
 * ```
 */
declare const RouteScope: (props: RouteScopeProps) => React.JSX.Element;
/**
 ...
 * ```
 */
declare function StateLink(props: StateLinkProps & Omit<HTMLProps<HTMLAnchorElement>, 'href'> & RefAttributes<HTMLAnchorElement>): import("react").JSX.Element;
/**
 * @internal
 */
...
export { type BaseIntentParams, type IntentJsonParams, IntentLink, type IntentLinkProps, type IntentParameters, type InternalSearchParam, Link, type LinkProps, type MatchError, type MatchOk, type MatchResult, type NavigateBaseOptions, type NavigateOptions, type NavigateOptionsWithState, type NextStateOrOptions, type Route, type RouteChildren, type RouteNodeOptions, type RouteObject, RouteScope, type RouteScopeProps, type RouteSegment, type RouteTransform, type Router, RouterContext, type RouterContextValue, type RouterNode, RouterProvider, type RouterProviderProps, type RouterState, STICKY_PARAMS, type SearchParam, StateLink, type StateLinkProps, type UseIntentLinkOptions, type UseLinkOptions, type UseStateLinkOptions, WithRouter, type WithRouterProps, _createNode, decodeJsonParams, encodeJsonParams, route, useIntentLink, useLink, useRouter, useRouterState, useStateLink, withRouter };
