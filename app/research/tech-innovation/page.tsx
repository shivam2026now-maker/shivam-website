...
export default async function TechInnovationPage() {
  const research = await getResearchByDomain("tech-innovation");
      ...
      <div className="mx-auto max-w-5xl px-6 py-12 sm:px-8 sm:py-20">
        ...
        <header className="mt-16">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-400">
            Research into emerging technologies, innovation, engineering
            ideas, and technologies shaping the future.
          </p>
        </header>
