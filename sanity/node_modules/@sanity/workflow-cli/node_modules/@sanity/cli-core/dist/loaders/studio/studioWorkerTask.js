...
import { deserializeStudioWorkerError, isStudioWorkerErrorMessage } from './studioWorkerLifecycle.js';
/**
 ...
 */ export function studioWorkerTask(filePath, options) {
    ...
    const workerPromise = promisifyWorker(new URL('studioWorkerLoader.worker.js', import.meta.url), {
        ...workerOptions,
        env: {
