 ...
 * @public
 */
export declare const ALLOWED_PROPERTIES: readonly [
  "fetch",
  "clone",
  "config",
  "withConfig",
 ...
 * @public
 */
export declare type ArrayElement<A> = A extends readonly (infer T)[]
  ? T
  : never;
...
export declare type CreateMutation<
  Doc extends Optional<SanityDocument, "_id">,
> = {
  document: Doc;
  type: "create";
};
...
export declare type DocumentMigrationReturnValue =
  Mutation | Mutation[] | NodePatch | NodePatch[] | Mutation_2 | Mutation_2[];
 ...
 * @public
 */
export declare function fromExportArchive(
  path: string,
...
export declare interface Migration<
  Def extends MigrateDefinition = MigrateDefinition,
> {
  /**
...
export declare type NodeMigrationReturnValue =
  DocumentMigrationReturnValue | Operation | Operation[];
 ...
 */
export declare function patch<P extends NodePatch | NodePatchList>(
  id: string,
  patches: P,
 ...
 * @public
 */
export declare class UnknownTransactionOutcomeError extends Error {
  /**
