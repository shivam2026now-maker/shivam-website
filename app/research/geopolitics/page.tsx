...
export default async function GeopoliticsPage() {
  const research = await getResearchByDomain("geopolitics");
      ...
      <div className="mx-auto max-w-5xl px-6 py-12 sm:px-8 sm:py-20">
        ...
        <header className="mt-16">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-400">
            Research and analysis of international relations, strategic
            affairs, power, security, and global developments.
          </p>
        </header>
