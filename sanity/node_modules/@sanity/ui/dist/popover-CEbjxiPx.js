...
import { _ as useTheme_v2, i as usePrefersReducedMotion, n as LayerProvider, o as useMediaIndex, s as Card, t as useLayer } from "./useLayer-jUJIz8mh.js";
...
import { a as useBoundaryElement, n as Portal, t as Arrow } from "./arrow-CL8xmdbg.js";
...
function PopoverCard(props) {
	let $ = c(59), animate, arrow, arrowRef, arrowX, arrowY, children, marginsProp, originX, originY, overflow, padding, placement, radius, ref, restProps, scheme, shadow, strategy, style, tone, width, xProp, yProp;
	...
	$[37] !== children || $[38] !== padding ? (t6 = /* @__PURE__ */ jsx(Flex, {
		direction: "column",
		flex: 1,
		padding,
		children
	}), $[37] = children, $[38] = padding, $[39] = t6) : t6 = $[39];
	let t7;
	$[40] !== overflow || $[41] !== t6 ? (t7 = /* @__PURE__ */ jsx(Flex, {
		"data-ui": "Popover__wrapper",
		direction: "column",
		flex: 1,
		overflow,
		children: t6
	}), $[40] = overflow, $[41] = t6, $[42] = t7) : t7 = $[42];
	let t8;
	$[43] !== arrow || $[44] !== arrowRef || $[45] !== arrowStyle ? (t8 = arrow && /* @__PURE__ */ jsx(Arrow, {
		ref: arrowRef,
		style: arrowStyle,
		width: 19,
		height: 8,
		radius: 2
	}), $[43] = arrow, $[44] = arrowRef, $[45] = arrowStyle, $[46] = t8) : t8 = $[46];
	let t9;
	return $[47] !== placement || $[48] !== radius || $[49] !== ref || $[50] !== restProps || $[51] !== rootStyle || $[52] !== scheme || $[53] !== shadow || $[54] !== t5 || $[55] !== t7 || $[56] !== t8 || $[57] !== tone ? (t9 = /* @__PURE__ */ jsxs(MotionCard, {
		"data-ui": "Popover",
		...restProps,
		...
		...t5,
		children: [t7, t8]
	}), $[47] = placement, $[48] = radius, $[49] = ref, $[50] = restProps, $[51] = rootStyle, $[52] = scheme, $[53] = shadow, $[54] = t5, $[55] = t7, $[56] = t8, $[57] = tone, $[58] = t9) : t9 = $[58], t9;
}
...
//# sourceMappingURL=popover-CEbjxiPx.js.map