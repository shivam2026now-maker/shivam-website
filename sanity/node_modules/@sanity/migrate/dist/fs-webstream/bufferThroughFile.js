 ...
 */ export function bufferThroughFile(source, filename, options) {
    ...
    function createBufferedReader() {
        ...
        return function tryReadFromBuffer(handle) {
            return _async_to_generator(function() {
                var buffer, bytesRead, ref, error;
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        case 0:
                            _state.trys.push([
                        ...
                        case 1:
                            ref = _state.sent(), buffer = ref.buffer, bytesRead = ref.bytesRead, ref;
                            return [
                                3,
                                3
                            ];
                    ...
                    return _ts_generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 2:
                                ...
                                if (!(bytesRead === 0 && (bufferDone || (signal === null || signal === void 0 ? void 0 : signal.aborted)))) return [
                                    3,
                                    4
                                ];
