...
export const SANITY_FUNCTION_PUBSUB = 'sanity.function.pubsub';
...
export const SANITY_FUNCTION_DURABLE = 'sanity.function.durable';
...
export const SANITY_STUDIO = 'sanity.studio';
...
export const EVENT_PUBSUB = 'pub-sub';
...
export const MAP_EVENT_TO_FUNCTION_TYPE = {
    ...
    [EVENT_PUBSUB]: SANITY_FUNCTION_PUBSUB,
...
export const LABEL_PUBSUB = 'PubSub';
export const LABEL_SCHEDULED = 'Scheduled';
export const LABEL_SYNC_TAG_INVALIDATE = 'Sync Tag Invalidate';
export const CI_SETUP_DOCS_URL = 'https://www.sanity.io/docs/blueprints/deploy-blueprints-from-ci';
export const STEP_PHASE_GLYPH = {
    start: '▶',
    complete: '✔',
    error: '✖',
};
