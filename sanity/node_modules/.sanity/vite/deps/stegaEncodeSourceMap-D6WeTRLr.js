import { So as y, bo as isRecord } from "./DoubleChevronRight-0HZnX8lW.js";
//#region node_modules/@sanity/sdk-react/node_modules/@sanity/client/dist/_chunks-es/stegaEncodeSourceMap.js
...
function encodeIntoResult(result, csm, encoder) {
	return walkMap(result, (value, path) => {
		...
		const sourceDocument = csm.documents[mapping.source.document], sourcePath = csm.paths[mapping.source.path], matchPathSegments = parseJsonPath(matchedPath);
		return encoder({
