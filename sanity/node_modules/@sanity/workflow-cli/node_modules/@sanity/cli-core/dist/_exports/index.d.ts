 ...
 * @public
 */
export declare const APP_VISIBILITIES: readonly [
  "default",
  "unlisted",
  "disabled",
];
...
/** @public */
export declare type AppVisibility = (typeof APP_VISIBILITIES)[number];
 ...
 */
export declare const coreAppManifestSchema: z.ZodMiniObject<
  {
...
declare interface PromisifyWorkerOptions extends WorkerOptions {
  /**
 ...
 */
export declare const studioManifestSchema: z.ZodMiniRecord<
