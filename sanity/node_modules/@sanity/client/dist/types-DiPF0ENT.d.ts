 ...
 * @beta
 */
interface PatchTargetDocumentRequest<T extends Record<string, Any$1> = Record<string, Any$1>> {
  /**
   * @see #AgentActionSchema.forcePublishedWrite
   */
...
/** @beta */
type PatchDocumentSync<T extends Record<string, Any$1> = Record<string, Any$1>> = (PatchExistingDocumentRequest | PatchTargetDocumentRequest<T>) & PatchRequestBase & AgentActionSync;
/** @beta */
type PatchDocumentAsync<T extends Record<string, Any$1> = Record<string, Any$1>> = (PatchExistingDocumentRequest | PatchTargetDocumentRequest<T>) & PatchRequestBase & AgentActionAsync;
/** @beta */
type PatchDocument<T extends Record<string, Any$1> = Record<string, Any$1>> = PatchDocumentSync<T> | PatchDocumentAsync<T>;
/**  @beta */
 ...
 * @beta
 */
interface PromptJsonResponse<T extends Record<string, Any$1> = Record<string, Any$1>> {
  /**
   *
...
/** @beta */
type PromptRequest<T extends Record<string, Any$1> = Record<string, Any$1>> = (PromptTextResponse | PromptJsonResponse<T>) & PromptRequestBase;
/** @beta */
...
/** @beta */
type TransformDocumentSync<T extends Record<string, Any$1> = Record<string, Any$1>> = TransformRequestBase & AgentActionSync;
/** @beta */
type TransformDocumentAsync = TransformRequestBase & AgentActionAsync;
/** @beta */
type TransformDocument<T extends Record<string, Any$1> = Record<string, Any$1>> = TransformDocumentSync<T> | TransformDocumentAsync;
/**  @beta */
...
/** @beta */
type TranslateDocumentSync<T extends Record<string, Any$1> = Record<string, Any$1>> = TranslateRequestBase & AgentActionSync;
/** @beta */
...
declare class ObservableAgentsActionClient {
   ...
   */
  generate<DocumentShape extends Record<string, Any$1>>(request: GenerateInstruction<DocumentShape>): Observable<(typeof request)['async'] extends true ? {
    _id: string;
   ...
   */
  transform<DocumentShape extends Record<string, Any$1>>(request: TransformDocument<DocumentShape>): Observable<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
  /**
   ...
   * @param request - translation request
   */
  translate<DocumentShape extends Record<string, Any$1>>(request: TranslateDocument<DocumentShape>): Observable<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
}
/** @public */
declare class AgentActionsClient {
   ...
   * @param request - instruction request
   */
  generate<DocumentShape extends Record<string, Any$1>>(request: GenerateInstruction<DocumentShape>): Promise<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
  /**
   * Transform a target document based on a source.
   * @param request - translation request
   */
  transform<DocumentShape extends Record<string, Any$1>>(request: TransformDocument<DocumentShape>): Promise<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
  /**
   * Translate a target document based on a source.
   * @param request - translation request
   */
  translate<DocumentShape extends Record<string, Any$1>>(request: TranslateDocument<DocumentShape>): Promise<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
  /**
   ...
   */
  prompt<const DocumentShape extends Record<string, Any$1>>(request: PromptRequest<DocumentShape>): Promise<(typeof request)['format'] extends 'json' ? DocumentShape : string>;
  /**
   * Patch a document using a schema aware API.
   * Does not use an LLM, but uses the schema to ensure paths and values matches the schema.
   * @param request - instruction request
   */
  patch<DocumentShape extends Record<string, Any$1>>(request: PatchDocument<DocumentShape>): Promise<(typeof request)['async'] extends true ? {
    _id: string;
  } : IdentifiedSanityDocumentStub & DocumentShape>;
}
/** @internal */
 ...
 * @public
 */
type ListenEventFromOptions<R extends Record<string, Any$1> = Record<string, Any$1>, Opts extends ListenOptions | ResumableListenOptions | undefined = undefined> = Opts extends ListenOptions | ResumableListenOptions ? Opts['events'] extends (ResumableListenEventNames | ListenEventName)[] ? MapListenEventNamesToListenEvents<R, Opts['events']> : ListenEvent<R> : MutationEvent<R>;
/**
 ...
 * @public
 */
declare function _listen<R extends Record<string, Any$1> = Record<string, Any$1>>(this: SanityClient$1 | ObservableSanityClient$1, query: string, params?: ListenParams): Observable<MutationEvent<R>>;
/**
 * Set up a listener that will be notified when mutations occur on documents matching the provided query/filter.
 *
 * @param query - GROQ-filter to listen to changes for
...
declare class LiveClient {
  #private;
  constructor(client: SanityClient$1 | ObservableSanityClient$1);
  /**
...
declare class BasePatch {
   ...
   */
  insert(at: 'before' | 'after' | 'replace', selector: string, items: Any$1[]): this;
  /**
   ...
   */
  append(selector: string, items: Any$1[]): this;
  /**
   ...
   */
  prepend(selector: string, items: Any$1[]): this;
  /**
   ...
   */
  splice(selector: string, start: number, deleteCount?: number, items?: Any$1[]): this;
  /**
   ...
   */
  reset(): this;
  protected _assign(op: keyof PatchOperations, props: Any$1, merge?: boolean): this;
  protected _set(op: keyof PatchOperations, props: Any$1): this;
}
/** @public */
declare class ObservablePatch extends BasePatch {
  #private;
  constructor(selection: PatchSelection, operations?: PatchOperations, client?: ObservableSanityClient$1);
  /**
   * Clones the patch
   */
   ...
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Commit the patch, returning an observable that produces an array of the mutated documents
   *
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   ...
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options?: BaseMutationOptions): Observable<SanityDocument$1<R>>;
}
/** @public */
declare class Patch extends BasePatch {
  #private;
  constructor(selection: PatchSelection, operations?: PatchOperations, client?: SanityClient$1);
  /**
   * Clones the patch
   */
  clone(): Patch;
   ...
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Commit the patch, returning a promise that resolves to an array of the mutated documents
   *
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   ...
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1> = Record<string, Any$1>>(options?: BaseMutationOptions): Promise<SanityDocument$1<R>>;
}
/** @public */
...
declare class BaseTransaction {
   ...
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(doc: SanityDocumentStub<R>): this;
  /**
   ...
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(doc: IdentifiedSanityDocumentStub<R>): this;
  /**
   ...
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(doc: IdentifiedSanityDocumentStub<R>): this;
  /**
...
declare class Transaction extends BaseTransaction {
  #private;
  constructor(operations?: Mutation[], client?: SanityClient$1, transactionId?: string);
  /**
   ...
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1>>(options: TransactionFirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Commit the transaction, returning a promise that resolves to an array of the mutated documents
   *
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1>>(options: TransactionAllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
...
declare class ObservableTransaction extends BaseTransaction {
  #private;
  constructor(operations?: Mutation[], client?: ObservableSanityClient$1, transactionId?: string);
  /**
   * Clones the transaction
   */
   ...
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1>>(options: TransactionFirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Commit the transaction, returning an observable that produces an array of the mutated documents
   *
   * @param options - Options for the mutation operation
   */
  commit<R extends Record<string, Any$1>>(options: TransactionAllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
...
declare class ObservableSanityClient$1 {
   ...
   */
  config(newConfig?: Partial<ClientConfig$1>): this;
  /**
   ...
   * @param options - Optional request options
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: G, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options?: FilteredResponseQueryOptions): Observable<ClientReturn$1<G, R>>;
  /**
   * Perform a GROQ-query against the configured dataset.
   *
   * @param query - GROQ-query to perform
   ...
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: string, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options: UnfilteredResponseQueryOptions): Observable<RawQueryResponse$1<ClientReturn$1<G, R>>>;
  /**
   * Perform a GROQ-query against the configured dataset.
   *
   * @param query - GROQ-query to perform
   ...
   * @param options - Request options
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: G, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options: UnfilteredResponseWithoutQuery): Observable<RawQuerylessQueryResponse<ClientReturn$1<G, R>>>;
  /**
   ...
   * @param options - Request options
   */
  getDocument<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options: {
    signal?: AbortSignal;
    tag?: string;
    releaseId?: string;
    includeAllVersions: true;
  }): Observable<SanityDocument$1<R>[]>;
  /**
   * Fetch a single document with the given ID.
   *
   * @param id - Document ID to fetch
  ...
  }): Observable<SanityDocument$1<R> | undefined>;
  /**
   ...
   * @param options - Request options
   */
  getDocuments<R extends Record<string, Any$1> = Record<string, Any$1>>(ids: string[], options?: {
    tag?: string;
  }): Observable<(SanityDocument$1<R> | null)[]>;
  /**
   ...
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Observable<SingleMutationResult>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   * Returns an observable that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Observable<MultipleMutationResult>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   * Returns an observable that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options?: BaseMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns an observable that resolves to an array containing the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns an observable that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Observable<SingleMutationResult>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns an observable that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Observable<MultipleMutationResult>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns an observable that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options?: BaseMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns an observable that resolves to an array containing the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns an observable that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Observable<SingleMutationResult>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Observable<MultipleMutationResult>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns an observable that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options?: BaseMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * @public
   *
   ...
   * ```
   */
  createVersion<R extends Record<string, Any$1>>(args: {
   ...
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Deletes a document with the given document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Deletes a document with the given document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(selection: MutationSelection, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Deletes one or more documents matching the given query or document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(selection: MutationSelection, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Deletes one or more documents matching the given query or document ID.
   ...
   * ```
   */
  replaceVersion<R extends Record<string, Any$1>>(args: {
    document: SanityDocumentStub<R>;
    publishedId: string;
    releaseId?: string;
  }, options?: BaseActionOptions): Observable<SingleActionResult | MultipleActionResult>;
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | ObservablePatch | ObservableTransaction, options: FirstDocumentMutationOptions): Observable<SanityDocument$1<R>>;
  /**
   * Perform mutation operations against the configured dataset.
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | ObservablePatch | ObservableTransaction, options: AllDocumentsMutationOptions): Observable<SanityDocument$1<R>[]>;
  /**
   * Perform mutation operations against the configured dataset
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | ObservablePatch | ObservableTransaction, options: FirstDocumentIdMutationOptions): Observable<SingleMutationResult>;
  /**
   * Perform mutation operations against the configured dataset
...
declare class SanityClient$1 {
   ...
   * @param options - Optional request options
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: G, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options?: FilteredResponseQueryOptions): Promise<ClientReturn$1<G, R>>;
  /**
   * Perform a GROQ-query against the configured dataset.
   *
   * @param query - GROQ-query to perform
   ...
   * @param options - Request options
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: G, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options: UnfilteredResponseQueryOptions): Promise<RawQueryResponse$1<ClientReturn$1<G, R>>>;
  /**
   * Perform a GROQ-query against the configured dataset.
   *
   * @param query - GROQ-query to perform
   ...
   * @param options - Request options
   */
  fetch<R = Any$1, Q extends QueryWithoutParams | QueryParams = QueryParams, const G extends string = string>(query: G, params: Q extends QueryWithoutParams ? QueryWithoutParams : Q, options: UnfilteredResponseWithoutQuery): Promise<RawQuerylessQueryResponse<ClientReturn$1<G, R>>>;
  /**
   * Fetch a single document with the given ID.
   *
   * @param id - Document ID to fetch
  ...
  getDocument<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options?: {
    ...
    releaseId?: string;
    includeAllVersions?: false;
  }): Promise<SanityDocument$1<R> | undefined>;
  /**
   * Fetch multiple documents in one request.
   * Should be used sparingly - performing a query is usually a better option.
   * The order/position of documents is preserved based on the original array of IDs.
  ...
  getDocuments<R extends Record<string, Any$1> = Record<string, Any$1>>(ids: string[], options?: {
    signal?: AbortSignal;
    tag?: string;
  }): Promise<(SanityDocument$1<R> | null)[]>;
  /**
   * Convenient and bandwidth efficient method of checking wether a set of document IDs exists.
   * Returns a set of the IDs that exist.
   *
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Promise<SingleMutationResult>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   * Returns a promise that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Promise<MultipleMutationResult>;
  /**
   * Create a document. Requires a `_type` property. If no `_id` is provided, it will be generated by the database.
   * Returns a promise that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  create<R extends Record<string, Any$1> = Record<string, Any$1>>(document: SanityDocumentStub<R>, options?: BaseMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns a promise that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns a promise that resolves to an array containing the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns a promise that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Promise<SingleMutationResult>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns a promise that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Promise<MultipleMutationResult>;
  /**
   * Create a document if no document with the same ID already exists.
   * Returns a promise that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createIfNotExists<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options?: BaseMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns a promise that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns a promise that resolves to an array containing the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns a promise that resolves to a mutation result object containing the ID of the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: FirstDocumentIdMutationOptions): Promise<SingleMutationResult>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options: AllDocumentIdsMutationOptions): Promise<MultipleMutationResult>;
  /**
   * Create a document if it does not exist, or replace a document with the same document ID
   * Returns a promise that resolves to the created document.
   *
   ...
   * @param options - Mutation options
   */
  createOrReplace<R extends Record<string, Any$1> = Record<string, Any$1>>(document: IdentifiedSanityDocumentStub<R>, options?: BaseMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * @public
   *
   * Creates a new version of a published document.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Deletes a document with the given document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(id: string, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Deletes a document with the given document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(selection: MutationSelection, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Deletes one or more documents matching the given query or document ID.
   ...
   * @param options - Options for the mutation
   */
  delete<R extends Record<string, Any$1> = Record<string, Any$1>>(selection: MutationSelection, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Deletes one or more documents matching the given query or document ID.
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | Patch | Transaction, options: FirstDocumentMutationOptions): Promise<SanityDocument$1<R>>;
  /**
   * Perform mutation operations against the configured dataset.
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | Patch | Transaction, options: AllDocumentsMutationOptions): Promise<SanityDocument$1<R>[]>;
  /**
   * Perform mutation operations against the configured dataset
   ...
   * @param options - Mutation options
   */
  mutate<R extends Record<string, Any$1> = Record<string, Any$1>>(operations: Mutation<R>[] | Patch | Transaction, options: FirstDocumentIdMutationOptions): Promise<SingleMutationResult>;
  /**
   * Perform mutation operations against the configured dataset
   ...
   */
  request<R = Any$1>(options: RawRequestOptions): Promise<R>;
  /**
   ...
   * @internal
   */
  dataRequest(endpoint: string, body: unknown, options?: BaseMutationOptions): Promise<Any$1>;
  /**
   * Get a Sanity API URL for the URI provided
   *
   * @param uri - URI/path to build URL for
...
/**  @beta */
type GenerateTargetDocument<T extends Record<string, Any$1> = Record<string, Any$1>> = {
  operation: 'edit';
  /**
   * @see #AgentActionSchema.forcePublishedWrite
   */
 ...
 * @beta
 */
interface GenerateTargetDocumentRequest<T extends Record<string, Any$1> = Record<string, Any$1>> {
  /**
   * @see #AgentActionSchema.forcePublishedWrite
   */
  targetDocument: GenerateTargetDocument<T>;
...
/** @beta */
type GenerateSyncInstruction<T extends Record<string, Any$1> = Record<string, Any$1>> = (GenerateExistingDocumentRequest | GenerateTargetDocumentRequest<T>) & GenerateRequestBase & AgentActionSync;
/** @beta */
type GenerateAsyncInstruction<T extends Record<string, Any$1> = Record<string, Any$1>> = (GenerateExistingDocumentRequest | GenerateTargetDocumentRequest<T>) & GenerateRequestBase & AgentActionAsync;
/** @beta */
 ...
 * @public
 */
type Requester = (options: Any$1) => Observable<unknown>;
/**
...
/** @public */
type ClientPerspective$1 = DeprecatedPreviewDrafts | 'published' | 'drafts' | 'raw' | StackablePerspective[];
/**
 * @public
 * @beta
 */
...
/** @internal */
type SanityDocument$1<T extends Record<string, Any$1> = Record<string, Any$1>> = { [P in keyof T]: T[P]; } & {
  _id: string;
  _rev: string;
  _type: string;
  _createdAt: string;
...
/** @internal */
interface SanityAssetDocument extends SanityDocument$1 {
  url: string;
  path: string;
  size: number;
  assetId: string;
...
/** @public */
type SanityDocumentStub<T extends Record<string, Any$1> = Record<string, Any$1>> = { [P in keyof T]: T[P]; } & {
  _type: string;
};
/** @public */
type IdentifiedSanityDocumentStub<T extends Record<string, Any$1> = Record<string, Any$1>> = { [P in keyof T]: T[P]; } & {
  _id: string;
} & SanityDocumentStub;
/** @internal */
type InsertPatch = {
...
/** @public */
type Mutation<R extends Record<string, Any$1> = Record<string, Any$1>> = {
 ...
 * @public
 */
type MutationEvent<R extends Record<string, Any$1> = Record<string, Any$1>> = {
  type: 'mutation';
  /**
   ...
   */
  previous?: SanityDocument$1<R> | null;
  /**
...
/** @public */
type ListenEvent<R extends Record<string, Any$1> = Record<string, Any$1>> = MutationEvent<R> | ReconnectEvent | WelcomeBackEvent | ResetEvent | WelcomeEvent | OpenEvent;
/** @public */
...
/** @public */
interface RawQueryResponse$1<R> {
  query: string;
  ms: number;
  result: R;
...
/** @internal */
interface ReleaseDocument extends SanityDocument$1 {
  /**
   * typically
   * `_.releases.<name>`
   */
...
/** @public */
type ContentSourceMapDocuments$1 = (ContentSourceMapDocument | ContentSourceMapRemoteDocument)[];
/** @public */
type ContentSourceMapPaths = string[];
/** @public */
interface ContentSourceMap$1 {
  mappings: ContentSourceMapMappings;
  documents: ContentSourceMapDocuments$1;
