...
Typically, the `@sanity/runtime-cli` (`sanity-run`) CLI is not used directly by end-users. The main `@sanity/cli` (`sanity`) loads and uses this CLI internally.  
All `sanity-run` commands can also be run as `sanity <command>` when `@sanity/cli` is available.  
...
_See code: [src/commands/blueprints/add.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/add.ts)_
...
_See code: [src/commands/blueprints/config.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/config.ts)_
...
_See code: [src/commands/blueprints/deploy.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/deploy.ts)_
...
```
USAGE
  $ sanity-run blueprints destroy [--json] [--project-id <value> --stack <value> -f] [--organization-id <value>  ]
    [--no-wait]
...
_See code: [src/commands/blueprints/destroy.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/destroy.ts)_
...
```
USAGE
  $ sanity-run blueprints doctor [--json] [-p <value>] [--fix]
...
_See code: [src/commands/blueprints/doctor.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/doctor.ts)_
...
```
USAGE
  $ sanity-run blueprints info [--json] [-v] [--stack <value>] [--project-id <value> | --organization-id <value>]
...
_See code: [src/commands/blueprints/info.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/info.ts)_
...
_See code: [src/commands/blueprints/init.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/init.ts)_
...
```
USAGE
  $ sanity-run blueprints logs [--stack <value>] [--project-id <value> | --organization-id <value>] [-l <value> | [-w
...
_See code: [src/commands/blueprints/logs.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/logs.ts)_
...
_See code: [src/commands/blueprints/mint-deploy-token.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/mint-deploy-token.ts)_
...
_See code: [src/commands/blueprints/plan.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/plan.ts)_
...
_See code: [src/commands/blueprints/promote.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/promote.ts)_
...
EXAMPLES
  ...
  $ sanity-run blueprints stacks --all
...
_See code: [src/commands/blueprints/stacks.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/blueprints/stacks.ts)_
...
```
USAGE
  $ sanity-run functions add [--json] [--example <value> | -n <value> | --type
    document-publish|document-create|document-delete|document-update|media-library-asset-create|media-library-asset-dele
    te|media-library-asset-update|pub-sub|scheduled-function|sync-tag-invalidate... | --language ts|js | --javascript |
...
_See code: [src/commands/functions/add.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/add.ts)_
...
EXAMPLES
  $ sanity-run functions dev --host 127.0.0.1 --port 3333

  $ sanity-run functions dev --timeout 60
```

_See code: [src/commands/functions/dev.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/dev.ts)_
...
```
USAGE
  $ sanity-run functions env add NAME KEY VALUE [--json] [--stack <value>]
...
EXAMPLES
  ...
  $ sanity-run functions env add --stack <name-or-id> MyFunction API_URL https://api.example.com/
```

_See code: [src/commands/functions/env/add.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/env/add.ts)_
...
```
USAGE
  $ sanity-run functions env list NAME [--json] [--stack <value>]
...
EXAMPLES
  ...
  $ sanity-run functions env list --stack <name-or-id> MyFunction
```

_See code: [src/commands/functions/env/list.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/env/list.ts)_
...
```
USAGE
  $ sanity-run functions env remove NAME KEY [--json] [--stack <value>]
...
EXAMPLES
  ...
  $ sanity-run functions env remove --stack <name-or-id> MyFunction API_URL
```

_See code: [src/commands/functions/env/remove.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/env/remove.ts)_
...
_See code: [src/commands/functions/logs.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/logs.ts)_
...
_See code: [src/commands/functions/test.ts](https://github.com/sanity-io/runtime-cli/blob/v17.11.1/src/commands/functions/test.ts)_
