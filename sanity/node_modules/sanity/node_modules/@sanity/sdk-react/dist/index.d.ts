...
interface UseApplyDocumentActions {
  (): <TDocumentType extends string = string, TDataset extends string = string, TProjectId extends string = string>(action: DocumentAction<TDocumentType, TDataset, TProjectId> | DocumentAction<TDocumentType, TDataset, TProjectId>[], options?: ResourceHandle) => Promise<ActionsResult<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>>>;
}
/**
 * @public
 *
 ...
 */
declare function useCreateDocument<TDocumentType extends string = string, TDataset extends string = string, TProjectId extends string = string>(options: DocumentTypeHandle<TDocumentType, TDataset, TProjectId>): (initialValue?: Partial<Omit<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>, IgnoredKey>>, overrides?: CreateDocumentOverrides) => Promise<DocumentHandle<TDocumentType, TDataset, TProjectId>>;
/**
 * @public
...
interface UseDocument {
  ...
  <TDocumentType extends string, TDataset extends string, TProjectId extends string = string>(options: UseDocumentOptions<undefined, TDocumentType, TDataset, TProjectId>): {
    data: SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`> | null;
  };
  /** @internal */
  <TPath extends string, TDocumentType extends string, TDataset extends string = string, TProjectId extends string = string>(options: UseDocumentOptions<TPath, TDocumentType>): {
    data: JsonMatch<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>, TPath> | undefined;
  };
  /** @internal */
 ...
 */
declare function useEditDocument<TDocumentType extends string = string, TDataset extends string = string, TProjectId extends string = string>(options: DocumentOptions<undefined, TDocumentType, TDataset, TProjectId>): (nextValue: Updater<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>>) => Promise<ActionsResult<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>>>;
/**
 * @public
 ...
 *          Returns a promise resolving to the {@link ActionsResult}.
 */
declare function useEditDocument<TPath extends string = string, TDocumentType extends string = string, TDataset extends string = string, TProjectId extends string = string>(options: DocumentOptions<TPath, TDocumentType, TDataset, TProjectId>): (nextValue: Updater<JsonMatch<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>, TPath>>) => Promise<ActionsResult<SanityDocument$1<TDocumentType, `${TProjectId}.${TDataset}`>>>;
/**
 * @public
 ...
 * ```
 */
declare function useDocumentProjection<TProjection extends string = string, TDocumentType extends string = string, TDataset extends string = string, TProjectId extends string = string>(options: useDocumentProjectionOptions<TProjection, TDocumentType, TDataset, TProjectId>): useDocumentProjectionResults<SanityProjectionResult<TProjection, TDocumentType, `${TProjectId}.${TDataset}`>>;
/**
 * @public
