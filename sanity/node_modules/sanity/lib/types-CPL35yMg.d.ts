 ...
 * @internal
 */
declare const serializableMarker: unique symbol;
/**
...
/** @internal */
declare function documentFromEditorWithInitialValue({ resolveDocumentNode, templates }: StructureContext, templateId: string, parameters?: Record<string, unknown>): DocumentBuilder;
/** @internal */
...
/** @internal */
declare function getOrderingMenuItem(context: StructureContext, { by, title, i18n }: SortOrdering): MenuItemBuilder;
/** @internal */
...
/** @internal */
declare const defaultIntentChecker: IntentChecker;
/**
...
export { defaultIntentChecker as $, MenuItemBuilder as $t, StructureToolFeatures as A, UnserializedListItemChild as At, UserComponent as B, GenericListInput as Bt, RouterPaneSiblingContext as C, ListItemBuilder as Ct, StructureResolver as D, ListItemSerializeOptions as Dt, StrictVersionLayeringOptions$1 as E, ListItemInput as Et, PaneLayoutContextValue as F, PartialDocumentList as Ft, ComponentBuilder as G, maybeSerializeMenuItemGroup as Gt, View as H, shallowIntentChecker as Ht, DefaultDocumentNodeContext as I, BaseGenericList as It, DEFAULT_INTENT_HANDLER as J, maybeSerializeInitialValueTemplateItem as Jt, ComponentInput as K, InitialValueTemplateItemBuilder as Kt, DefaultDocumentNodeResolver as L, BuildableGenericList as Lt, StructureToolPaneActionHandler as M, DocumentListBuilder as Mt, UnresolvedPaneNode as N, DocumentListInput as Nt, StructureResolverContext as O, PartialListItem as Ot, PaneContextValue as P, DocumentListOptions as Pt, IntentParams as Q, MenuItemActionType as Qt, StructureBuilder as R, GenericList as Rt, RouterPaneSibling as S, ItemChild as Sn, ListItem as St, SerializablePaneNode as T, ListItemDisplayOptions as Tt, BuildableComponent as U, MenuItemGroup as Ut, UserViewComponent as V, ListDisplayOptions as Vt, Component$1 as W, MenuItemGroupBuilder as Wt, IntentChecker as X, KnownMenuItemParams as Xt, Intent as Y, menuItemsFromInitialValueTemplateItems as Yt, IntentJsonParams as Z, MenuItem as Zt, PaneMenuItem as _, ComponentView as _n, DocumentListItem as _t, ParameterizedLinkProps as a, maybeSerializeMenuItem as an, DocumentNode as at, PaneNodeResolver as b, ChildResolver as bn, PartialDocumentListItem as bt, DocumentPaneInfoContextValue as c, PartialDocumentNode as cn, SerializeOptions as ct, DocumentFieldMenuActionNode as d, BaseView as dn, BuildableList as dt, MenuItemParamsType as en, Builder as et, DocumentListPaneNode as f, GenericViewBuilder as fn, List as ft, PaneListItemDivider as g, FormViewBuilder as gn, DocumentTypeListInput as gt, PaneListItem as h, FormView as hn, DocumentTypeListBuilder as ht, PaneRouterContextValue as i, getOrderingMenuItemsForSchemaType as in, Divider as it, StructureToolOptions as j, DocumentList as jt, StructureToolContextValue as k, UnserializedListItem as kt, BaseResolvedPaneNode as l, documentFromEditor as ln, SerializePath as lt, ListPaneNode as m, maybeSerializeView as mn, ListInput as mt, ChildLinkProps as n, SortMenuItem as nn, Collection as nt, ReferenceChildLinkProps as o, DocumentBuilder as on, EditorNode as ot, DocumentPaneNode as p, ViewBuilder as pn, ListBuilder as pt, BaseIntentParams as q, defaultInitialValueTemplateItems as qt, EditReferenceOptions as r, getOrderingMenuItem as rn, CollectionBuilder as rt, DocumentPaneContextValue as s, DocumentOptions as sn, Serializable as st, BackLinkProps as t, PartialMenuItem as tn, Child as tt, CustomComponentPaneNode as u, documentFromEditorWithInitialValue as un, StructureNode as ut, PaneMenuItemGroup as v, ComponentViewBuilder as vn, DocumentListItemBuilder as vt, RouterPanes as w, ListItemChild as wt, RouterPaneGroup as x, ChildResolverOptions as xn, isDocumentListItem as xt, PaneNode as y, ChildObservable as yn, DocumentListItemInput as yt, StructureContext as z, GenericListBuilder as zt };
//# sourceMappingURL=types-CPL35yMg.d.ts.map