 ...
 */
declare function doImport(source: string): Promise<any>;
 ...
 * @internal
 */
declare function importModule<T = unknown>(filePath: string | URL, options?: ImportModuleOptions): Promise<T>;
 ...
 * @internal
 */
declare function safeStructuredClone<T>(obj: T): T;
export { isCi as a, isInteractive as i, normalizePath as n, importModule as o, isStaging as r, doImport as s, safeStructuredClone as t };
//# sourceMappingURL=safeStructuredClone-CWB0MXmH.d.ts.map